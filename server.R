...
function(input, output, session) {
  ...
  step1_import_design_eg <- reactive({
    req(input$act_step1_import_design_eg)
    design_df <- read.xlsx("InputData/sce_design.xlsx", sheet = 1, colNames = TRUE, rowNames = F) %>% 
      dplyr::mutate_all(as.character)
    
    return(design_df)
  })
  
  observeEvent(input$act_step1_import_design_eg, {
    ## output the table
    output$out_step1_import_design_eg <- DT::renderDataTable(server = F, {
      DT::datatable(step1_import_design_eg(), rownames = FALSE, filter = "top", extensions = 'Buttons',
        ...
        formatStyle(names(step1_import_design_eg()), textAlign = "right") 
    })
  })
  ...
  ## 1.3 show the example annotation file #################
  ## import the example annotation
  step1_import_anno_eg <- reactive({
    req(input$act_step1_import_anno_eg)

    annotation_df <- read.xlsx("InputData/1.reference/sce_gene_mess.xlsx",
                               sheet = 1, 
  ...
  observeEvent(input$act_step1_import_anno_eg, {
    ## output the table
    output$out_step1_import_anno_eg <- DT::renderDataTable(server = T, {
      DT::datatable(step1_import_anno_eg(), rownames = FALSE, filter = "top", extensions = 'Buttons',
                    options = list(pageLength = 10, 
                                   lengthMenu = c(10, 50, 100, 500, 1000),
                                   scrollX = TRUE, 
                                   dom = 'lBfrtipc',
                                   buttons = list(
                                     list(extend = 'csv', filename = "example_table"), 
                                     list(extend = 'excel', filename = "example_table")))) %>% 
        formatStyle(names(step1_import_anno_eg()), textAlign = "right") 
    })
  })
  ...
  ## 2.0 show the example mapping file #################
  ## import the example mapping
  step2_import_align_eg <- reactive({
    req(input$act_step2_import_align_eg)
    
    align_table <- read.table("InputData/3.rna-seq/2.bowtie/RNA_seq_mapping.txt",
                              sep = '\t', header = TRUE, stringsAsFactors = FALSE)
    
    return(align_table)
  })
  
  observeEvent(input$act_step2_import_align_eg, {
    ## output the table
    output$out_step2_import_align_eg <- DT::renderDataTable(server = T, {
      DT::datatable(step2_import_align_eg(), rownames = FALSE, filter = "top", extensions = 'Buttons',
                    options = list(pageLength = 10, 
                                   lengthMenu = c(10, 50, 100, 500, 1000),
                                   scrollX = TRUE, 
                                   dom = 'lBfrtipc',
                                   buttons = list(
                                     list(extend = 'csv', filename = "example_table"), 
                                     list(extend = 'excel', filename = "example_table")))) %>% 
        formatStyle(names(step2_import_align_eg()), textAlign = "right") 
    })
  })
  ...
  ## 3.0 show the example RNA-seq distribution file #################
  ## import the example distribution data
  step3_import_rna_length_eg <- reactive({
    req(input$act_step3_import_rna_length_eg)
    
    distribution_table <- read.table("InputData/3.rna-seq/5.riboparser/01.qc/RNA_length_distribution.txt",
                              sep = '\t', header = TRUE, stringsAsFactors = FALSE)
    
    return(distribution_table)
  })
  
  observeEvent(input$act_step3_import_rna_length_eg, {
    ## output the table
    output$out_step3_import_rna_length_eg <- DT::renderDataTable(server = T, {
      DT::datatable(step3_import_rna_length_eg(), rownames = FALSE, filter = "top", extensions = 'Buttons',
                    options = list(pageLength = 10, 
                                   lengthMenu = c(10, 50, 100, 500, 1000),
                                   scrollX = TRUE, 
                                   dom = 'lBfrtipc',
                                   buttons = list(
                                     list(extend = 'csv', filename = "example_table"), 
                                     list(extend = 'excel', filename = "example_table")))) %>% 
        formatStyle(names(step3_import_rna_length_eg()), textAlign = "right") 
    })
  })
  ...
  ## 3.3 show the example Ribo-seq distribution file #################
  ## import the example distribution data
  step3_import_ribo_length_eg <- reactive({
    req(input$act_step3_import_ribo_length_eg)
    
    align_table <- read.table("InputData/4.ribo-seq/5.riboparser/01.qc/RIBO_length_distribution.txt",
                              sep = '\t', header = TRUE, stringsAsFactors = FALSE)
    
    return(align_table)
  })
  
  observeEvent(input$act_step3_import_ribo_length_eg, {
    ## output the table
    output$out_step3_import_ribo_length_eg <- DT::renderDataTable(server = T, {
      DT::datatable(step3_import_ribo_length_eg(), rownames = FALSE, filter = "top", extensions = 'Buttons',
                    options = list(pageLength = 10, 
                                   lengthMenu = c(10, 50, 100, 500, 1000),
                                   scrollX = TRUE, 
                                   dom = 'lBfrtipc',
                                   buttons = list(
                                     list(extend = 'csv', filename = "example_table"), 
                                     list(extend = 'excel', filename = "example_table")))) %>% 
        formatStyle(names(step3_import_ribo_length_eg()), textAlign = "right") 
    })
  })
  
  ## 3.4 import the Ribo-seq distribution data #################
  ## import the distribution data
  ...
  ## 3.5 draw the Ribo-seq distribution data #################
  ## import the distribution data
  ...
  ## 4.0 show the example saturation file #################
  ## import the example saturation
  step4_import_rna_saturation_eg <- reactive({
    req(input$act_step4_import_rna_saturation_eg)
    
    saturation_table <- read.table("InputData/3.rna-seq/5.riboparser/01.qc/RNA_gene_saturation.txt",
                              sep = '\t', header = TRUE, stringsAsFactors = FALSE)
    
    return(saturation_table)
  })
  
  observeEvent(input$act_step4_import_rna_saturation_eg, {
    ## output the table
    output$out_step4_import_rna_saturation_eg <- DT::renderDataTable(server = T, {
      DT::datatable(step4_import_rna_saturation_eg(), rownames = FALSE, filter = "top", extensions = 'Buttons',
                    options = list(pageLength = 10, 
                                   lengthMenu = c(10, 50, 100, 500, 1000),
                                   scrollX = TRUE, 
                                   dom = 'lBfrtipc',
                                   buttons = list(
                                     list(extend = 'csv', filename = "example_table"), 
                                     list(extend = 'excel', filename = "example_table")))) %>% 
        formatStyle(names(step4_import_rna_saturation_eg()), textAlign = "right") 
    })
  })
  
  step4_import_ribo_saturation_eg <- reactive({
    req(input$act_step4_import_ribo_saturation_eg)
    
    saturation_table <- read.table("InputData/4.ribo-seq/5.riboparser/01.qc/RIBO_gene_saturation.txt",
                                   sep = '\t', header = TRUE, stringsAsFactors = FALSE)
    
    return(saturation_table)
  })
  
  observeEvent(input$act_step4_import_ribo_saturation_eg, {
    ## output the table
    output$out_step4_import_ribo_saturation_eg <- DT::renderDataTable(server = T, {
      DT::datatable(step4_import_ribo_saturation_eg(), rownames = FALSE, filter = "top", extensions = 'Buttons',
                    options = list(pageLength = 10, 
                                   lengthMenu = c(10, 50, 100, 500, 1000),
                                   scrollX = TRUE, 
                                   dom = 'lBfrtipc',
                                   buttons = list(
                                     list(extend = 'csv', filename = "example_table"), 
                                     list(extend = 'excel', filename = "example_table")))) %>% 
        formatStyle(names(step4_import_ribo_saturation_eg()), textAlign = "right") 
    })
  })
  ...
  ## 5.0 show the example reads digestion file #################
  ## import the example reads digestion
  step5_import_ribo_digestion_eg <- reactive({
    req(input$step5_import_ribo_digestion_eg)
    
    digestion_table <- read.table("InputData/3.ribo-seq/5.riboparser/02.digestion/RIBO_reads_digestion.txt",
                                   sep = '\t', header = TRUE, stringsAsFactors = FALSE)
    
    return(digestion_table)
  })
  
  observeEvent(input$act_step5_import_ribo_digestion_eg, {
    ## output the table
    output$out_step5_import_ribo_digestion_eg <- DT::renderDataTable(server = T, {
      DT::datatable(step5_import_ribo_digestion_eg(), rownames = FALSE, filter = "top", extensions = 'Buttons',
                    options = list(pageLength = 10, 
                                   lengthMenu = c(10, 50, 100, 500, 1000),
                                   scrollX = TRUE, 
                                   dom = 'lBfrtipc',
                                   buttons = list(
                                     list(extend = 'csv', filename = "example_table"), 
                                     list(extend = 'excel', filename = "example_table")))) %>% 
        formatStyle(names(step5_import_ribo_digestion_eg()), textAlign = "right") 
    })
  })
  ...
  ## 6.0 show the example rsbm offset file #################
  ## import the example rsbm offset
  step6_import_frame_offset_eg <- reactive({
    req(input$act_step6_import_frame_offset_eg)
    
    digestion_table <- read.table("InputData/4.ribo-seq/5.riboparser/03.offset/RIBO_RSBM_offset.txt",
                                  sep = '\t', header = TRUE, stringsAsFactors = FALSE)
    
    return(digestion_table)
  })
  
  observeEvent(input$act_step6_import_frame_offset_eg, {
    ## output the table
    output$out_step6_import_frame_offset_eg <- DT::renderDataTable(server = T, {
      DT::datatable(step6_import_frame_offset_eg(), rownames = FALSE, filter = "top", extensions = 'Buttons',
                    options = list(pageLength = 10, 
                                   lengthMenu = c(10, 50, 100, 500, 1000),
                                   scrollX = TRUE, 
                                   dom = 'lBfrtipc',
                                   buttons = list(
                                     list(extend = 'csv', filename = "example_table"), 
                                     list(extend = 'excel', filename = "example_table")))) %>% 
        formatStyle(names(step6_import_frame_offset_eg()), textAlign = "right") 
    })
  })
  
  ## import the example sscbm offset
  step6_import_tis_offset_eg <- reactive({
    req(input$act_step6_import_tis_offset_eg)
    
    digestion_table <- read.table("InputData/4.ribo-seq/5.riboparser/03.offset/RIBO_SSCBM_offset.txt",
                                  sep = '\t', header = TRUE, stringsAsFactors = FALSE)
    
    return(digestion_table)
  })
  
  observeEvent(input$act_step6_import_tis_offset_eg, {
    ## output the table
    output$out_step6_import_tis_offset_eg <- DT::renderDataTable(server = T, {
      DT::datatable(step6_import_tis_offset_eg(), rownames = FALSE, filter = "top", extensions = 'Buttons',
                    options = list(pageLength = 10, 
                                   lengthMenu = c(10, 50, 100, 500, 1000),
                                   scrollX = TRUE, 
                                   dom = 'lBfrtipc',
                                   buttons = list(
                                     list(extend = 'csv', filename = "example_table"), 
                                     list(extend = 'excel', filename = "example_table")))) %>% 
        formatStyle(names(step6_import_tis_offset_eg()), textAlign = "right") 
    })
  })
  
  ## import the example offset end detail
  step6_import_end_offset_eg <- reactive({
    req(input$act_step6_import_end_offset_eg)
    
    digestion_table <- read.table("InputData/4.ribo-seq/5.riboparser/03.offset/RIBO_offset_end.txt",
                                  sep = '\t', header = TRUE, stringsAsFactors = FALSE)
    
    return(digestion_table)
  })
  
  observeEvent(input$act_step6_import_end_offset_eg, {
    ## output the table
    output$out_step6_import_end_offset_eg <- DT::renderDataTable(server = T, {
      DT::datatable(step6_import_end_offset_eg(), rownames = FALSE, filter = "top", extensions = 'Buttons',
                    options = list(pageLength = 10, 
                                   lengthMenu = c(10, 50, 100, 500, 1000),
                                   scrollX = TRUE, 
                                   dom = 'lBfrtipc',
                                   buttons = list(
                                     list(extend = 'csv', filename = "example_table"), 
                                     list(extend = 'excel', filename = "example_table")))) %>% 
        formatStyle(names(step6_import_end_offset_eg()), textAlign = "right") 
    })
  })
  
  ## 6.1 import the rsbm offset data #################
  ## import the rsbm offset
  ...
  ## 7.0 show the example periodicity file #################
  ## import the example RNA periodicity
  step7_import_rna_period_eg <- reactive({
    req(input$act_step7_import_rna_period_eg)
    
    digestion_table <- read.table("InputData/3.rna-seq/5.riboparser/06.periodicity/RNA_periodicity.txt",
                                  sep = '\t', header = TRUE, stringsAsFactors = FALSE)
    
    return(digestion_table)
  })
  
  observeEvent(input$act_step7_import_rna_period_eg, {
    ## output the table
    output$out_step7_import_rna_period_eg <- DT::renderDataTable(server = T, {
      DT::datatable(step7_import_rna_period_eg(), rownames = FALSE, filter = "top", extensions = 'Buttons',
                    options = list(pageLength = 10, 
                                   lengthMenu = c(10, 50, 100, 500, 1000),
                                   scrollX = TRUE, 
                                   dom = 'lBfrtipc',
                                   buttons = list(
                                     list(extend = 'csv', filename = "example_table"), 
                                     list(extend = 'excel', filename = "example_table")))) %>% 
        formatStyle(names(step7_import_rna_period_eg()), textAlign = "right") 
    })
  })
  
  ## import the example RIBO periodicity
  step7_import_ribo_period_eg <- reactive({
    req(input$act_step7_import_ribo_period_eg)
    
    digestion_table <- read.table("InputData/4.ribo-seq/5.riboparser/06.periodicity/RIBO_periodicity.txt",
                                  sep = '\t', header = TRUE, stringsAsFactors = FALSE)
    
    return(digestion_table)
  })
  
  observeEvent(input$act_step7_import_ribo_period_eg, {
    ## output the table
    output$out_step7_import_ribo_period_eg <- DT::renderDataTable(server = T, {
      DT::datatable(step7_import_ribo_period_eg(), rownames = FALSE, filter = "top", extensions = 'Buttons',
                    options = list(pageLength = 10, 
                                   lengthMenu = c(10, 50, 100, 500, 1000),
                                   scrollX = TRUE, 
                                   dom = 'lBfrtipc',
                                   buttons = list(
                                     list(extend = 'csv', filename = "example_table"), 
                                     list(extend = 'excel', filename = "example_table")))) %>% 
        formatStyle(names(step7_import_ribo_period_eg()), textAlign = "right") 
    })
  })
  ...
  ## 8.0 show the example metagene file #################
  ## import the example RNA metagene
  step8_import_rna_meta_eg <- reactive({
    req(input$act_step8_import_rna_meta_eg)
    
    digestion_table <- read.table("InputData/3.rna-seq/5.riboparser/07.metaplot/RNA_tis_tts_metaplot.txt",
                                  sep = '\t', header = TRUE, stringsAsFactors = FALSE)
    
    return(digestion_table)
  })
  
  observeEvent(input$act_step8_import_rna_meta_eg, {
    ## output the table
    output$out_step8_import_rna_meta_eg <- DT::renderDataTable(server = T, {
      DT::datatable(step8_import_rna_meta_eg(), rownames = FALSE, filter = "top", extensions = 'Buttons',
                    options = list(pageLength = 10, 
                                   lengthMenu = c(10, 50, 100, 500, 1000),
                                   scrollX = TRUE, 
                                   dom = 'lBfrtipc',
                                   buttons = list(
                                     list(extend = 'csv', filename = "example_table"), 
                                     list(extend = 'excel', filename = "example_table")))) %>% 
        formatStyle(names(step8_import_rna_meta_eg()), textAlign = "right") 
    })
  })
  
  ## import the example RIBO metagene
  step8_import_ribo_meta_eg <- reactive({
    req(input$act_step8_import_ribo_meta_eg)
    
    digestion_table <- read.table("InputData/4.ribo-seq/5.riboparser/07.metaplot/RIBO_tis_tts_metaplot.txt",
                                  sep = '\t', header = TRUE, stringsAsFactors = FALSE)
    
    return(digestion_table)
  })
  
  observeEvent(input$act_step8_import_ribo_meta_eg, {
    ## output the table
    output$out_step8_import_ribo_meta_eg <- DT::renderDataTable(server = T, {
      DT::datatable(step8_import_ribo_meta_eg(), rownames = FALSE, filter = "top", extensions = 'Buttons',
                    options = list(pageLength = 10, 
                                   lengthMenu = c(10, 50, 100, 500, 1000),
                                   scrollX = TRUE, 
                                   dom = 'lBfrtipc',
                                   buttons = list(
                                     list(extend = 'csv', filename = "example_table"), 
                                     list(extend = 'excel', filename = "example_table")))) %>% 
        formatStyle(names(step8_import_ribo_meta_eg()), textAlign = "right") 
    })
  })
  ...
  ## 9.0 show the example coverage file #################
  ## import the example RNA coverage
  step9_import_rna_coverage_eg <- reactive({
    req(input$act_step9_import_rna_coverage_eg)
    
    digestion_table <- read.table("InputData/3.rna-seq/5.riboparser/08.coverage/RNA_utr5_cds_utr3_mean_coverage_density.txt",
                                  sep = '\t', header = TRUE, stringsAsFactors = FALSE)
    
    return(digestion_table)
  })
  
  observeEvent(input$act_step9_import_rna_coverage_eg, {
    ## output the table
    output$out_step9_import_rna_coverage_eg <- DT::renderDataTable(server = T, {
      DT::datatable(step9_import_rna_coverage_eg(), rownames = FALSE, filter = "top", extensions = 'Buttons',
                    options = list(pageLength = 10, 
                                   lengthMenu = c(10, 50, 100, 500, 1000),
                                   scrollX = TRUE, 
                                   dom = 'lBfrtipc',
                                   buttons = list(
                                     list(extend = 'csv', filename = "example_table"), 
                                     list(extend = 'excel', filename = "example_table")))) %>% 
        formatStyle(names(step9_import_rna_coverage_eg()), textAlign = "right") 
    })
  })
  
  ## import the example RIBO coverage
  step9_import_ribo_coverage_eg <- reactive({
    req(input$act_step9_import_ribo_coverage_eg)
    
    digestion_table <- read.table("InputData/4.ribo-seq/5.riboparser/08.coverage/RIBO_utr5_cds_utr3_mean_coverage_density.txt",
                                  sep = '\t', header = TRUE, stringsAsFactors = FALSE)
    
    return(digestion_table)
  })
  
  observeEvent(input$act_step9_import_ribo_coverage_eg, {
    ## output the table
    output$out_step9_import_ribo_coverage_eg <- DT::renderDataTable(server = T, {
      DT::datatable(step9_import_ribo_coverage_eg(), rownames = FALSE, filter = "top", extensions = 'Buttons',
                    options = list(pageLength = 10, 
                                   lengthMenu = c(10, 50, 100, 500, 1000),
                                   scrollX = TRUE, 
                                   dom = 'lBfrtipc',
                                   buttons = list(
                                     list(extend = 'csv', filename = "example_table"), 
                                     list(extend = 'excel', filename = "example_table")))) %>% 
        formatStyle(names(step9_import_ribo_coverage_eg()), textAlign = "right") 
    })
  })
  ...
  step9_rna_coverage <- reactive({
    ...
    rna_coverage_table <- read.table(input$in_step9_rnaseq$datapath, 
                                     sep = '\t', header = TRUE, stringsAsFactors = FALSE) %>% 
      dplyr::rename("Value" = !!sym(input$in_step9_rna_value))
    ...
    if (input$in_step9_rna_x == 'Sample') {
      ...
      asymmetry_score <- rna_coverage_table %>%
        ...
        dplyr::arrange(Bins) %>%
        summarise(
          first_half = sum(Value[1:(n()/2)]),
          second_half = sum(Value[(n()/2 + 1):n()]),
    ...
    return(list(rna_coverage_table = rna_coverage_table %>% 
                  dplyr::rename(!!sym(input$in_step9_rna_value) := "Value"),
  ...
  step9_rna_coverage_plot <- reactive({
    ...
    coverage_line_plot <- draw_coverage(coverage = coverage_df, plot_type = "Line",
                                        x = "Bins", y = input$in_step9_rna_value,
                                        xlabel = input$out_step9_rna_xlabel, 
                                        ylabel = input$out_step9_rna_ylabel,
                                        group = input$in_step9_rna_x, 
    ...
    coverage_heat_plot <- draw_coverage(coverage = coverage_df, plot_type = "Heat",
                                        ...
                                        group = input$in_step9_rna_value, 
                                        xlabel = input$out_step9_rna_xlabel, ylabel = input$out_step9_rna_ylabel,
                                        font_size = input$in_step9_rna_font_size,
  ...
  step9_ribo_coverage <- reactive({
    ...
    ribo_coverage_table <- read.table(input$in_step9_riboseq$datapath, 
                                      sep = '\t', header = TRUE, stringsAsFactors = FALSE) %>% 
      dplyr::rename("Value" = !!sym(input$in_step9_ribo_value))
    ...
    return(list(ribo_coverage_table = ribo_coverage_table %>% 
                  dplyr::rename(!!sym(input$in_step9_ribo_value) := "Value"),
                asymmetry_score = asymmetry_score))
  })
  ...
  step9_ribo_coverage_plot <- reactive({
    ...
    coverage_line_plot <- draw_coverage(coverage = coverage_df, plot_type = "Line",
                                        x = "Bins", y = input$in_step9_ribo_value,
                                        xlabel = input$out_step9_ribo_xlabel, 
                                        ylabel = input$out_step9_ribo_ylabel,
                                        group = input$in_step9_ribo_x, 
    ...
    coverage_heat_plot <- draw_coverage(coverage = coverage_df, plot_type = "Heat",
                                        ...
                                        group = input$in_step9_ribo_value, 
                                        xlabel = input$out_step9_ribo_xlabel, 
                                        ylabel = input$out_step9_ribo_ylabel,
                                        font_size = input$in_step9_ribo_font_size,
  ...
  ## 10.0 show the example abundance file #################
  ## import the example RNA abundance
  step10_import_rna_count_eg <- reactive({
    req(input$act_step10_import_rna_count_eg)
    
    digestion_table <- read.table("InputData/3.rna-seq/4.quantification/isoforms.expected_count.txt",
                                  sep = '\t', header = TRUE, stringsAsFactors = FALSE)
    
    return(digestion_table)
  })
  
  observeEvent(input$act_step10_import_rna_count_eg, {
    ## output the table
    output$out_step10_import_rna_count_eg <- DT::renderDataTable(server = T, {
      DT::datatable(step10_import_rna_count_eg(), rownames = FALSE, filter = "top", extensions = 'Buttons',
                    options = list(pageLength = 10, 
                                   lengthMenu = c(10, 50, 100, 500, 1000),
                                   scrollX = TRUE, 
                                   dom = 'lBfrtipc',
                                   buttons = list(
                                     list(extend = 'csv', filename = "example_table"), 
                                     list(extend = 'excel', filename = "example_table")))) %>% 
        formatStyle(names(step10_import_rna_count_eg()), textAlign = "right") 
    })
  })
  
  ## import the example RIBO abundance
  step10_import_ribo_count_eg <- reactive({
    req(input$act_step10_import_ribo_count_eg)
    
    digestion_table <- read.table("InputData/4.ribo-seq/5.riboparser/10.quantification/RIBO_cds_rpf_quant.txt",
                                  sep = '\t', header = TRUE, stringsAsFactors = FALSE)
    
    return(digestion_table)
  })
  
  observeEvent(input$act_step10_import_ribo_count_eg, {
    ## output the table
    output$out_step10_import_ribo_count_eg <- DT::renderDataTable(server = T, {
      DT::datatable(step10_import_ribo_count_eg(), rownames = FALSE, filter = "top", extensions = 'Buttons',
                    options = list(pageLength = 10, 
                                   lengthMenu = c(10, 50, 100, 500, 1000),
                                   scrollX = TRUE, 
                                   dom = 'lBfrtipc',
                                   buttons = list(
                                     list(extend = 'csv', filename = "example_table"), 
                                     list(extend = 'excel', filename = "example_table")))) %>% 
        formatStyle(names(step10_import_ribo_count_eg()), textAlign = "right") 
    })
  })
  ...
  ### 11.0 show the example abundance file #################
  ## import the example RNA abundance
  step11_import_rna_norm_eg <- reactive({
    req(input$act_step11_import_rna_norm_eg)
    
    digestion_table <- read.table("InputData/3.rna-seq/4.quantification/isoforms.FPKM.txt",
                                  sep = '\t', header = TRUE, stringsAsFactors = FALSE)
    
    return(digestion_table)
  })
  
  observeEvent(input$act_step11_import_rna_norm_eg, {
    ## output the table
    output$out_step11_import_rna_norm_eg <- DT::renderDataTable(server = T, {
      DT::datatable(step11_import_rna_norm_eg(), rownames = FALSE, filter = "top", extensions = 'Buttons',
                    options = list(pageLength = 10, 
                                   lengthMenu = c(10, 50, 100, 500, 1000),
                                   scrollX = TRUE, 
                                   dom = 'lBfrtipc',
                                   buttons = list(
                                     list(extend = 'csv', filename = "example_table"), 
                                     list(extend = 'excel', filename = "example_table")))) %>% 
        formatStyle(names(step11_import_rna_norm_eg()), textAlign = "right") 
    })
  })
  
  ## import the example RIBO abundance
  step11_import_ribo_norm_eg <- reactive({
    req(input$act_step11_import_ribo_norm_eg)
    
    digestion_table <- read.table("InputData/4.ribo-seq/5.riboparser/10.quantification/RIBO_cds_rpm_quant.txt",
                                  sep = '\t', header = TRUE, stringsAsFactors = FALSE)
    
    return(digestion_table)
  })
  
  observeEvent(input$act_step11_import_ribo_norm_eg, {
    ## output the table
    output$out_step11_import_ribo_norm_eg <- DT::renderDataTable(server = T, {
      DT::datatable(step11_import_ribo_norm_eg(), rownames = FALSE, filter = "top", extensions = 'Buttons',
                    options = list(pageLength = 10, 
                                   lengthMenu = c(10, 50, 100, 500, 1000),
                                   scrollX = TRUE, 
                                   dom = 'lBfrtipc',
                                   buttons = list(
                                     list(extend = 'csv', filename = "example_table"), 
                                     list(extend = 'excel', filename = "example_table")))) %>% 
        formatStyle(names(step11_import_ribo_norm_eg()), textAlign = "right") 
    })
  })
  
  ## import the example RIBO abundance
  step11_import_te_norm_eg <- reactive({
    req(input$act_step11_import_te_norm_eg)
    
    digestion_table <- read.table("InputData/results/TE-normalized-2025-02-20.txt",
                                  sep = '\t', header = TRUE, stringsAsFactors = FALSE)
    
    return(digestion_table)
  })
  
  observeEvent(input$act_step11_import_te_norm_eg, {
    ## output the table
    output$out_step11_import_te_norm_eg <- DT::renderDataTable(server = T, {
      DT::datatable(step11_import_te_norm_eg(), rownames = FALSE, filter = "top", extensions = 'Buttons',
                    options = list(pageLength = 10, 
                                   lengthMenu = c(10, 50, 100, 500, 1000),
                                   scrollX = TRUE, 
                                   dom = 'lBfrtipc',
                                   buttons = list(
                                     list(extend = 'csv', filename = "example_table"), 
                                     list(extend = 'excel', filename = "example_table")))) %>% 
        formatStyle(names(step11_import_te_norm_eg()), textAlign = "right") 
    })
  })
  ...
  ### 12.0 show the example abundance file #################
  ## import the example RNA abundance
  step12_import_rna_norm_eg <- reactive({
    req(input$act_step12_import_rna_norm_eg)
  ...
  observeEvent(input$act_step12_import_rna_norm_eg, {
    ## output the table
    output$out_step12_import_rna_norm_eg <- DT::renderDataTable(server = T, {
      DT::datatable(step12_import_rna_norm_eg(), rownames = FALSE, filter = "top", extensions = 'Buttons',
                    options = list(pageLength = 10, 
                                   lengthMenu = c(10, 50, 100, 500, 1000),
                                   scrollX = TRUE, 
                                   dom = 'lBfrtipc',
                                   buttons = list(
                                     list(extend = 'csv', filename = "example_table"), 
                                     list(extend = 'excel', filename = "example_table")))) %>% 
        formatStyle(names(step12_import_rna_norm_eg()), textAlign = "right") 
    })
  })
  
  ## import the example RIBO abundance
  step12_import_ribo_norm_eg <- reactive({
    req(input$act_step12_import_ribo_norm_eg)
  ...
  observeEvent(input$act_step12_import_ribo_norm_eg, {
    ## output the table
    output$out_step12_import_ribo_norm_eg <- DT::renderDataTable(server = T, {
      DT::datatable(step12_import_ribo_norm_eg(), rownames = FALSE, filter = "top", extensions = 'Buttons',
                    options = list(pageLength = 10, 
                                   lengthMenu = c(10, 50, 100, 500, 1000),
                                   scrollX = TRUE, 
                                   dom = 'lBfrtipc',
                                   buttons = list(
                                     list(extend = 'csv', filename = "example_table"), 
                                     list(extend = 'excel', filename = "example_table")))) %>% 
        formatStyle(names(step12_import_ribo_norm_eg()), textAlign = "right") 
    })
  })
  
  ## import the example TE abundance
  step12_import_te_norm_eg <- reactive({
    req(input$act_step12_import_te_norm_eg)
  ...
  observeEvent(input$act_step12_import_te_norm_eg, {
    ## output the table
    output$out_step12_import_te_norm_eg <- DT::renderDataTable(server = T, {
      DT::datatable(step12_import_te_norm_eg(), rownames = FALSE, filter = "top", extensions = 'Buttons',
                    options = list(pageLength = 10, 
                                   lengthMenu = c(10, 50, 100, 500, 1000),
                                   scrollX = TRUE, 
                                   dom = 'lBfrtipc',
                                   buttons = list(
                                     list(extend = 'csv', filename = "example_table"), 
                                     list(extend = 'excel', filename = "example_table")))) %>% 
        formatStyle(names(step12_import_te_norm_eg()), textAlign = "right") 
    })
  })
  ...
  ### 11.0 show the example abundance file #################
  ## import the example RNA abundance
  step13_import_edger_eg <- reactive({
    req(input$act_step13_import_edger_eg)
  ...
  observeEvent(input$act_step13_import_edger_eg, {
    ## output the table
    output$out_step13_import_edger_eg <- DT::renderDataTable(server = T, {
      DT::datatable(step13_import_edger_eg(), rownames = FALSE, filter = "top", extensions = 'Buttons',
                    options = list(pageLength = 10, 
                                   lengthMenu = c(10, 50, 100, 500, 1000),
                                   scrollX = TRUE, 
                                   dom = 'lBfrtipc',
                                   buttons = list(
                                     list(extend = 'csv', filename = "example_table"), 
                                     list(extend = 'excel', filename = "example_table")))) %>% 
        formatStyle(names(step13_import_edger_eg()), textAlign = "right") 
    })
  })
  
  ## import the example deseq2 abundance
  step13_import_deseq2_eg <- reactive({
    req(input$act_step13_import_deseq2_eg)
  ...
  observeEvent(input$act_step13_import_deseq2_eg, {
    ## output the table
    output$out_step13_import_deseq2_eg <- DT::renderDataTable(server = T, {
      DT::datatable(step13_import_deseq2_eg(), rownames = FALSE, filter = "top", extensions = 'Buttons',
                    options = list(pageLength = 10, 
                                   lengthMenu = c(10, 50, 100, 500, 1000),
                                   scrollX = TRUE, 
                                   dom = 'lBfrtipc',
                                   buttons = list(
                                     list(extend = 'csv', filename = "example_table"), 
                                     list(extend = 'excel', filename = "example_table")))) %>% 
        formatStyle(names(step13_import_deseq2_eg()), textAlign = "right") 
    })
  })
  
  ## import the example TE abundance
  step13_import_deltate_eg <- reactive({
    req(input$act_step13_import_deltate_eg)
  ...
  observeEvent(input$act_step13_import_deltate_eg, {
    ## output the table
    output$out_step13_import_deltate_eg <- DT::renderDataTable(server = T, {
      DT::datatable(step13_import_deltate_eg(), rownames = FALSE, filter = "top", extensions = 'Buttons',
                    options = list(pageLength = 10, 
                                   lengthMenu = c(10, 50, 100, 500, 1000),
                                   scrollX = TRUE, 
                                   dom = 'lBfrtipc',
                                   buttons = list(
                                     list(extend = 'csv', filename = "example_table"), 
                                     list(extend = 'excel', filename = "example_table")))) %>% 
        formatStyle(names(step13_import_deltate_eg()), textAlign = "right") 
    })
  })
  ...
  step13_run_edger <- reactive({
    ...
    # browser()
    if (input$in_step13_edger_ruvseq == "False") {
    ...
    edger_res <- run_edger(
      ...
      edger_res <- run_edger_ruvseq(
        exprs = step13_edger_exprs()$edger_exprs,
        design = step13_edger_exprs()$flt_design, # filtered design table
        method = input$in_step13_edger_test,
        emprical = input$in_step13_edger_emprical_gene,
        bcv = input$in_step13_edger_bcv, # bcv for filter the DEGs
        padj_cutoff = input$in_step13_edger_padj, # padj for filter the DEGs
        log2fc_cutoff = input$in_step13_edger_log2fc, # log2fc for filter the DEGs
        flt_sig = F, # filter the sig diff genes
  ...
  step13_run_deseq2 <- reactive({
    ...
    # browser()
    if (input$in_step13_deseq2_ruvseq == "False") {
      ...
      # run the deseq2 analysis with RUVseq
      deseq2_res <- run_deseq2_ruvseq(
        exprs = step13_deseq2_exprs()$gene_exprs,
        design = step13_deseq2_exprs()$flt_design, # filtered design table
        # method = input$in_step13_deseq2_test,
        emprical = input$in_step13_deseq2_emprical_gene,
        padj_cutoff = input$in_step13_deseq2_padj, # padj for filter the DEGs
        log2fc_cutoff = input$in_step13_deseq2_log2fc, # log2fc for filter the DEGs
        flt_sig = F, # filter the sig diff genes
        anno = anno, # annotation table
  ...
  ### 14.0 show the example abundance file #################
  ## import the example volcano abundance
  step14_import_vol_degs_eg <- reactive({
    req(input$act_step14_import_vol_degs_eg)
    
    vol_degs <- read.xlsx("InputData/results/sce-deltaTE-results-2025-02-20.xlsx",
                          sheet = 1, colNames = T, rowNames = F)
    
    return(vol_degs)
  })
  
  observeEvent(input$act_step14_import_vol_degs_eg, {
    ## output the table
    output$out_step14_import_vol_degs_eg <- DT::renderDataTable(server = T, {
      DT::datatable(step14_import_vol_degs_eg(), rownames = FALSE, filter = "top", extensions = 'Buttons',
                    options = list(pageLength = 10, 
                                   lengthMenu = c(10, 50, 100, 500, 1000),
                                   scrollX = TRUE, 
                                   dom = 'lBfrtipc',
                                   buttons = list(
                                     list(extend = 'csv', filename = "example_table"), 
                                     list(extend = 'excel', filename = "example_table")))) %>% 
        formatStyle(names(step14_import_vol_degs_eg()), textAlign = "right") 
    })
  })
  
  ## import the example quadra abundance
  step14_import_quadra_degs_eg <- reactive({
    req(input$act_step14_import_quadra_degs_eg)
  ...
  observeEvent(input$act_step14_import_quadra_degs_eg, {
    ## output the table
    output$out_step14_import_quadra_degs_eg <- DT::renderDataTable(server = T, {
      DT::datatable(step14_import_quadra_degs_eg(), rownames = FALSE, filter = "top", extensions = 'Buttons',
                    options = list(pageLength = 10, 
                                   lengthMenu = c(10, 50, 100, 500, 1000),
                                   scrollX = TRUE, 
                                   dom = 'lBfrtipc',
                                   buttons = list(
                                     list(extend = 'csv', filename = "example_table"), 
                                     list(extend = 'excel', filename = "example_table")))) %>% 
        formatStyle(names(step14_import_quadra_degs_eg()), textAlign = "right") 
    })
  })
  
  ## import the example deltaTE abundance
  step14_import_delta_degs_eg <- reactive({
    req(input$act_step14_import_delta_degs_eg)
  ...
  observeEvent(input$act_step14_import_delta_degs_eg, {
    ## output the table
    output$out_step14_import_delta_degs_eg <- DT::renderDataTable(server = T, {
      DT::datatable(step14_import_delta_degs_eg(), rownames = FALSE, filter = "top", extensions = 'Buttons',
                    options = list(pageLength = 10, 
                                   lengthMenu = c(10, 50, 100, 500, 1000),
                                   scrollX = TRUE, 
                                   dom = 'lBfrtipc',
                                   buttons = list(
                                     list(extend = 'csv', filename = "example_table"), 
                                     list(extend = 'excel', filename = "example_table")))) %>% 
        formatStyle(names(step14_import_delta_degs_eg()), textAlign = "right") 
    })
  })
  ...
  ### 15.0 show the example DEGs file #################
  ## import the example DEGs
  step15_venn_calc_eg <- reactive({
    req(input$act_step15_venn_calc_eg)
  ...
  observeEvent(input$act_step15_venn_calc_eg, {
    ## output the table
    output$out_step15_venn_calc_eg <- DT::renderDataTable(server = T, {
      DT::datatable(step15_venn_calc_eg(), rownames = FALSE, filter = "top", extensions = 'Buttons',
                    options = list(pageLength = 10, 
                                   lengthMenu = c(10, 50, 100, 500, 1000),
                                   scrollX = TRUE, 
                                   dom = 'lBfrtipc',
                                   buttons = list(
                                     list(extend = 'csv', filename = "example_table"), 
                                     list(extend = 'excel', filename = "example_table")))) %>% 
        formatStyle(names(step15_venn_calc_eg()), textAlign = "right") 
    })
  })
  
  ## import the example DEGs
  step15_degs_venn_import_eg <- reactive({
    req(input$act_step15_degs_venn_import_eg)
  ...
  observeEvent(input$act_step15_degs_venn_import_eg, {
    ## output the table
    output$out_step15_degs_venn_import_eg <- DT::renderDataTable(server = T, {
      DT::datatable(step15_degs_venn_import_eg(), rownames = FALSE, filter = "top", extensions = 'Buttons',
                    options = list(pageLength = 10, 
                                   lengthMenu = c(10, 50, 100, 500, 1000),
                                   scrollX = TRUE, 
                                   dom = 'lBfrtipc',
                                   buttons = list(
                                     list(extend = 'csv', filename = "example_table"), 
                                     list(extend = 'excel', filename = "example_table")))) %>% 
        formatStyle(names(step15_degs_venn_import_eg()), textAlign = "right") 
    })
  })
  
  ## import the example DEGs
  step15_import_merge_degs_eg <- reactive({
    req(input$act_step15_import_merge_degs_eg)
  ...
  observeEvent(input$act_step15_import_merge_degs_eg, {
    ## output the table
    output$out_step15_import_merge_degs_eg <- DT::renderDataTable(server = T, {
      DT::datatable(step15_import_merge_degs_eg(), rownames = FALSE, filter = "top", extensions = 'Buttons',
                    options = list(pageLength = 10, 
                                   lengthMenu = c(10, 50, 100, 500, 1000),
                                   scrollX = TRUE, 
                                   dom = 'lBfrtipc',
                                   buttons = list(
                                     list(extend = 'csv', filename = "example_table"), 
                                     list(extend = 'excel', filename = "example_table")))) %>% 
        formatStyle(names(step15_import_merge_degs_eg()), textAlign = "right") 
    })
  })
  ...
  ### 16.0 show the example DEGs file #################
  ## import the example DEGs
  step16_import_go_degs_eg <- reactive({
    req(input$act_step16_import_go_degs_eg)
  ...
  observeEvent(input$act_step16_import_go_degs_eg, {
    ## output the table
    output$out_step16_import_go_degs_eg <- DT::renderDataTable(server = T, {
      DT::datatable(step16_import_go_degs_eg(), rownames = FALSE, filter = "top", extensions = 'Buttons',
                    options = list(pageLength = 10, 
                                   lengthMenu = c(10, 50, 100, 500, 1000),
                                   scrollX = TRUE, 
                                   dom = 'lBfrtipc',
                                   buttons = list(
                                     list(extend = 'csv', filename = "example_table"), 
                                     list(extend = 'excel', filename = "example_table")))) %>% 
        formatStyle(names(step16_import_go_degs_eg()), textAlign = "right") 
    })
  })
  
  ## import the example DEGs
  step16_import_group_go_degs_eg <- reactive({
    req(input$act_step16_import_group_go_degs_eg)
  ...
  observeEvent(input$act_step16_import_group_go_degs_eg, {
    ## output the table
    output$out_step16_import_group_go_degs_eg <- DT::renderDataTable(server = T, {
      DT::datatable(step16_import_group_go_degs_eg(), rownames = FALSE, filter = "top", extensions = 'Buttons',
                    options = list(pageLength = 10, 
                                   lengthMenu = c(10, 50, 100, 500, 1000),
                                   scrollX = TRUE, 
                                   dom = 'lBfrtipc',
                                   buttons = list(
                                     list(extend = 'csv', filename = "example_table"), 
                                     list(extend = 'excel', filename = "example_table")))) %>% 
        formatStyle(names(step16_import_group_go_degs_eg()), textAlign = "right") 
    })
  })
  ...
  ### 17.0 show the example DEGs file #################
  ## import the example DEGs
  step17_import_go_gsea_degs_eg <- reactive({
    req(input$act_step17_import_go_gsea_degs_eg)
  ...
  observeEvent(input$act_step17_import_go_gsea_degs_eg, {
    ## output the table
    output$out_step17_import_go_gsea_degs_eg <- DT::renderDataTable(server = T, {
      DT::datatable(step17_import_go_gsea_degs_eg(), rownames = FALSE, filter = "top", extensions = 'Buttons',
                    options = list(pageLength = 10, 
                                   lengthMenu = c(10, 50, 100, 500, 1000),
                                   scrollX = TRUE, 
                                   dom = 'lBfrtipc',
                                   buttons = list(
                                     list(extend = 'csv', filename = "example_table"), 
                                     list(extend = 'excel', filename = "example_table")))) %>% 
        formatStyle(names(step17_import_go_gsea_degs_eg()), textAlign = "right") 
    })
  })
  ...
  ### 18.0 show the example DEGs file #################
  ## import the example DEGs
  step18_import_kegg_degs_eg <- reactive({
    req(input$act_step18_import_kegg_degs_eg)
  ...
  observeEvent(input$act_step18_import_kegg_degs_eg, {
    ## output the table
    output$out_step18_import_kegg_degs_eg <- DT::renderDataTable(server = T, {
      DT::datatable(step18_import_kegg_degs_eg(), rownames = FALSE, filter = "top", extensions = 'Buttons',
                    options = list(pageLength = 10, 
                                   lengthMenu = c(10, 50, 100, 500, 1000),
                                   scrollX = TRUE, 
                                   dom = 'lBfrtipc',
                                   buttons = list(
                                     list(extend = 'csv', filename = "example_table"), 
                                     list(extend = 'excel', filename = "example_table")))) %>% 
        formatStyle(names(step18_import_kegg_degs_eg()), textAlign = "right") 
    })
  })
  
  ## import the example DEGs
  step18_import_group_kegg_degs_eg <- reactive({
    req(input$act_step18_import_group_kegg_degs_eg)
  ...
  observeEvent(input$act_step18_import_group_kegg_degs_eg, {
    ## output the table
    output$out_step18_import_group_kegg_degs_eg <- DT::renderDataTable(server = T, {
      DT::datatable(step18_import_group_kegg_degs_eg(), rownames = FALSE, filter = "top", extensions = 'Buttons',
                    options = list(pageLength = 10, 
                                   lengthMenu = c(10, 50, 100, 500, 1000),
                                   scrollX = TRUE, 
                                   dom = 'lBfrtipc',
                                   buttons = list(
                                     list(extend = 'csv', filename = "example_table"), 
                                     list(extend = 'excel', filename = "example_table")))) %>% 
        formatStyle(names(step18_import_group_kegg_degs_eg()), textAlign = "right") 
    })
  })
  ...
  ### 19.0 show the example DEGs file #################
  ## import the example DEGs
  step19_import_kegg_gsea_degs_eg <- reactive({
    req(input$act_step19_import_kegg_gsea_degs_eg)
  ...
  observeEvent(input$act_step19_import_kegg_gsea_degs_eg, {
    ## output the table
    output$out_step19_import_kegg_gsea_degs_eg <- DT::renderDataTable(server = T, {
      DT::datatable(step19_import_kegg_gsea_degs_eg(), rownames = FALSE, filter = "top", extensions = 'Buttons',
                    options = list(pageLength = 10, 
                                   lengthMenu = c(10, 50, 100, 500, 1000),
                                   scrollX = TRUE, 
                                   dom = 'lBfrtipc',
                                   buttons = list(
                                     list(extend = 'csv', filename = "example_table"), 
                                     list(extend = 'excel', filename = "example_table")))) %>% 
        formatStyle(names(step19_import_kegg_gsea_degs_eg()), textAlign = "right") 
    })
  })
  ...
  ### 20.0 show the example codon usage file #################
  ## import the example codon usage
  step20_import_codon_table_eg <- reactive({
    req(input$act_step20_import_codon_table_eg)
    
    vol_degs <- read.xlsx("InputData/results/sce-CDS-gene-codon-usage-2025-02-20.xlsx",
                          sheet = 1, colNames = T, rowNames = F)
    
    return(vol_degs)
  })
  
  observeEvent(input$act_step20_import_codon_table_eg, {
    ## output the table
    output$out_step20_import_codon_table_eg <- DT::renderDataTable(server = T, {
      DT::datatable(step20_import_codon_table_eg(), rownames = FALSE, filter = "top", extensions = 'Buttons',
                    options = list(pageLength = 10, 
                                   lengthMenu = c(10, 50, 100, 500, 1000),
                                   scrollX = TRUE, 
                                   dom = 'lBfrtipc',
                                   buttons = list(
                                     list(extend = 'csv', filename = "example_table"), 
                                     list(extend = 'excel', filename = "example_table")))) %>% 
        formatStyle(names(step20_import_codon_table_eg()), textAlign = "right") 
    })
  })
  
  ## import the example codon usage
  step20_go_import_codon_table_eg <- reactive({
    req(input$act_step20_go_import_codon_table_eg)
  ...
  observeEvent(input$act_step20_go_import_codon_table_eg, {
    ## output the table
    output$out_step20_go_import_codon_table_eg <- DT::renderDataTable(server = T, {
      DT::datatable(step20_go_import_codon_table_eg(), rownames = FALSE, filter = "top", extensions = 'Buttons',
                    options = list(pageLength = 10, 
                                   lengthMenu = c(10, 50, 100, 500, 1000),
                                   scrollX = TRUE, 
                                   dom = 'lBfrtipc',
                                   buttons = list(
                                     list(extend = 'csv', filename = "example_table"), 
                                     list(extend = 'excel', filename = "example_table")))) %>% 
        formatStyle(names(step20_go_import_codon_table_eg()), textAlign = "right") 
    })
  })
  
  ## import the example codon usage
  step20_kegg_import_codon_table_eg <- reactive({
    req(input$act_step20_kegg_import_codon_table_eg)
  ...
  observeEvent(input$act_step20_kegg_import_codon_table_eg, {
    ## output the table
    output$out_step20_kegg_import_codon_table_eg <- DT::renderDataTable(server = T, {
      DT::datatable(step20_kegg_import_codon_table_eg(), rownames = FALSE, filter = "top", extensions = 'Buttons',
                    options = list(pageLength = 10, 
                                   lengthMenu = c(10, 50, 100, 500, 1000),
                                   scrollX = TRUE, 
                                   dom = 'lBfrtipc',
                                   buttons = list(
                                     list(extend = 'csv', filename = "example_table"), 
                                     list(extend = 'excel', filename = "example_table")))) %>% 
        formatStyle(names(step20_kegg_import_codon_table_eg()), textAlign = "right")
    })
  })
  ...
  step20_codon_usage_table <- reactive({
    ...
    req(input$act_step20_import_codon_table)
  ...
  ## output the table
  observeEvent(input$act_step20_import_codon_table, {
  ...
  ### 21.0 show the example gene density file #################
  ## import the example gene density
  step21_isoforms_import_ribo_seq_eg <- reactive({
    req(input$act_step21_isoforms_import_ribo_seq_eg)

    isoforms_ribo_reads <- fread(file = "InputData/4.ribo-seq/5.riboparser/18.retrieve/RIBO_retrieve.txt",
                                 index = NULL, header="auto", check.names = FALSE, sep = '\t')
    return(isoforms_ribo_reads)
  })
  
  observeEvent(input$act_step21_isoforms_import_ribo_seq_eg, {
    ## output the table
    output$out_step21_isoforms_import_ribo_seq_eg <- DT::renderDataTable(server = T, {
      DT::datatable(step21_isoforms_import_ribo_seq_eg(), rownames = FALSE, filter = "top", extensions = 'Buttons',
                    options = list(pageLength = 10, 
                                   lengthMenu = c(10, 50, 100, 500, 1000),
                                   scrollX = TRUE, 
                                   dom = 'lBfrtipc',
                                   buttons = list(
                                     list(extend = 'csv', filename = "example_table"), 
                                     list(extend = 'excel', filename = "example_table")))) %>% 
        formatStyle(names(step21_isoforms_import_ribo_seq_eg()), textAlign = "right") 
    })
  })
  ...
  ### 22.0 show the example pausing score file #################
  ## import the example pausing score
  step22_import_pausing_eg <- reactive({
    req(input$act_step22_import_pausing_eg)
    
    isoforms_ribo_reads <- fread(file = "InputData/4.ribo-seq/5.riboparser/11.pausing_score/A_site_sum_codon_pausing_score.txt",
                                 index = NULL, header="auto", check.names = FALSE, sep = '\t')
    return(isoforms_ribo_reads)
  })
  
  observeEvent(input$act_step22_import_pausing_eg, {
    ## output the table
    output$out_step22_import_pausing_eg <- DT::renderDataTable(server = T, {
      DT::datatable(step22_import_pausing_eg(), rownames = FALSE, filter = "top", extensions = 'Buttons',
                    options = list(pageLength = 10, 
                                   lengthMenu = c(10, 50, 100, 500, 1000),
                                   scrollX = TRUE, 
                                   dom = 'lBfrtipc',
                                   buttons = list(
                                     list(extend = 'csv', filename = "example_table"), 
                                     list(extend = 'excel', filename = "example_table")))) %>% 
        formatStyle(names(step22_import_pausing_eg()), textAlign = "right") 
    })
  })
  
  ## import the example pausing score
  step22_diff_import_pausing_eg <- reactive({
    req(input$act_step22_diff_import_pausing_eg)
  ...
  observeEvent(input$act_step22_diff_import_pausing_eg, {
    ## output the table
    output$out_step22_diff_import_pausing_eg <- DT::renderDataTable(server = T, {
      DT::datatable(step22_diff_import_pausing_eg(), rownames = FALSE, filter = "top", extensions = 'Buttons',
                    options = list(pageLength = 10, 
                                   lengthMenu = c(10, 50, 100, 500, 1000),
                                   scrollX = TRUE, 
                                   dom = 'lBfrtipc',
                                   buttons = list(
                                     list(extend = 'csv', filename = "example_table"), 
                                     list(extend = 'excel', filename = "example_table")))) %>% 
        formatStyle(names(step22_diff_import_pausing_eg()), textAlign = "right") 
    })
  })
  ...
  ### 23.0 show the example codon Occupancy file #################
  ## import the example codon Occupancy
  step23_import_occupancy_eg <- reactive({
    req(input$act_step23_import_occupancy_eg)
    
    isoforms_ribo_reads <- fread(file = "InputData/4.ribo-seq/5.riboparser/12.codon_occupancy/A_site_codon_occupancy.txt",
                                 index = NULL, header="auto", check.names = FALSE, sep = '\t')
    return(isoforms_ribo_reads)
  })
  
  observeEvent(input$act_step23_import_occupancy_eg, {
    ## output the table
    output$out_step23_import_occupancy_eg <- DT::renderDataTable(server = T, {
      DT::datatable(step23_import_occupancy_eg(), rownames = FALSE, filter = "top", extensions = 'Buttons',
                    options = list(pageLength = 10, 
                                   lengthMenu = c(10, 50, 100, 500, 1000),
                                   scrollX = TRUE, 
                                   dom = 'lBfrtipc',
                                   buttons = list(
                                     list(extend = 'csv', filename = "example_table"), 
                                     list(extend = 'excel', filename = "example_table")))) %>% 
        formatStyle(names(step23_import_occupancy_eg()), textAlign = "right") 
    })
  })
  
  ## import the example codon Occupancy
  step23_diff_import_occupancy_eg <- reactive({
    req(input$act_step23_diff_import_occupancy_eg)
  ...
  observeEvent(input$act_step23_diff_import_occupancy_eg, {
    ## output the table
    output$out_step23_diff_import_occupancy_eg <- DT::renderDataTable(server = T, {
      DT::datatable(step23_diff_import_occupancy_eg(), rownames = FALSE, filter = "top", extensions = 'Buttons',
                    options = list(pageLength = 10, 
                                   lengthMenu = c(10, 50, 100, 500, 1000),
                                   scrollX = TRUE, 
                                   dom = 'lBfrtipc',
                                   buttons = list(
                                     list(extend = 'csv', filename = "example_table"), 
                                     list(extend = 'excel', filename = "example_table")))) %>% 
        formatStyle(names(step23_diff_import_occupancy_eg()), textAlign = "right") 
    })
  })
  ...
  ### 24.0 show the example codon decoding time file #################
  ## import the example codon decoding time
  step24_import_cdt_eg <- reactive({
    req(input$act_step24_import_cdt_eg)
    
    isoforms_ribo_reads <- fread(file = "InputData/4.ribo-seq/5.riboparser/13.codon_decoding_time/A_site_cdt.txt",
                                 index = NULL, header="auto", check.names = FALSE, sep = '\t')
    return(isoforms_ribo_reads)
  })
  
  observeEvent(input$act_step24_import_cdt_eg, {
    ## output the table
    output$out_step24_import_cdt_eg <- DT::renderDataTable(server = T, {
      DT::datatable(step24_import_cdt_eg(), rownames = FALSE, filter = "top", extensions = 'Buttons',
                    options = list(pageLength = 10, 
                                   lengthMenu = c(10, 50, 100, 500, 1000),
                                   scrollX = TRUE, 
                                   dom = 'lBfrtipc',
                                   buttons = list(
                                     list(extend = 'csv', filename = "example_table"), 
                                     list(extend = 'excel', filename = "example_table")))) %>% 
        formatStyle(names(step24_import_cdt_eg()), textAlign = "right") 
    })
  })
  
  ## import the example codon decoding time
  step24_diff_import_cdt_eg <- reactive({
    req(input$act_step24_diff_import_cdt_eg)
  ...
  observeEvent(input$act_step24_diff_import_cdt_eg, {
    ## output the table
    output$out_step24_diff_import_cdt_eg <- DT::renderDataTable(server = T, {
      DT::datatable(step24_diff_import_cdt_eg(), rownames = FALSE, filter = "top", extensions = 'Buttons',
                    options = list(pageLength = 10, 
                                   lengthMenu = c(10, 50, 100, 500, 1000),
                                   scrollX = TRUE, 
                                   dom = 'lBfrtipc',
                                   buttons = list(
                                     list(extend = 'csv', filename = "example_table"), 
                                     list(extend = 'excel', filename = "example_table")))) %>% 
        formatStyle(names(step24_diff_import_cdt_eg()), textAlign = "right") 
    })
  })
  ...
  ### 25.0 show the example codon decoding time file #################
  ## import the example codon decoding time
  step25_import_cst_eg <- reactive({
    req(input$act_step25_import_cst_eg)
    
    isoforms_ribo_reads <- fread(file = "InputData/4.ribo-seq/5.riboparser/14.codon_selection_time/A_site_codon_selection_time.txt",
                                 index = NULL, header="auto", check.names = FALSE, sep = '\t')
    return(isoforms_ribo_reads)
  })
  
  observeEvent(input$act_step25_import_cst_eg, {
    ## output the table
    output$out_step25_import_cst_eg <- DT::renderDataTable(server = T, {
      DT::datatable(step25_import_cst_eg(), rownames = FALSE, filter = "top", extensions = 'Buttons',
                    options = list(pageLength = 10, 
                                   lengthMenu = c(10, 50, 100, 500, 1000),
                                   scrollX = TRUE, 
                                   dom = 'lBfrtipc',
                                   buttons = list(
                                     list(extend = 'csv', filename = "example_table"), 
                                     list(extend = 'excel', filename = "example_table")))) %>% 
        formatStyle(names(step25_import_cst_eg()), textAlign = "right") 
    })
  })
  
  ## import the example codon decoding time
  step25_diff_import_cst_eg <- reactive({
    req(input$act_step25_diff_import_cst_eg)
  ...
  observeEvent(input$act_step25_diff_import_cst_eg, {
    ## output the table
    output$out_step25_diff_import_cst_eg <- DT::renderDataTable(server = T, {
      DT::datatable(step25_diff_import_cst_eg(), rownames = FALSE, filter = "top", extensions = 'Buttons',
                    options = list(pageLength = 10, 
                                   lengthMenu = c(10, 50, 100, 500, 1000),
                                   scrollX = TRUE, 
                                   dom = 'lBfrtipc',
                                   buttons = list(
                                     list(extend = 'csv', filename = "example_table"), 
                                     list(extend = 'excel', filename = "example_table")))) %>% 
        formatStyle(names(step25_diff_import_cst_eg()), textAlign = "right") 
    })
  })
  ...
  ### 27.0 show the example coefficient of variation file #################
  ## import the example coefficient of variation
  step27_import_cov_eg <- reactive({
    req(input$act_step27_import_cov_eg)
    
    isoforms_ribo_reads <- fread(file = "InputData/4.ribo-seq/5.riboparser/15.coefficient_of_variation/RIBO_CoV.txt",
                                 index = NULL, header="auto", check.names = FALSE, sep = '\t')
    return(isoforms_ribo_reads)
  })
  
  observeEvent(input$act_step27_import_cov_eg, {
    ## output the table
    output$out_step27_import_cov_eg <- DT::renderDataTable(server = T, {
      DT::datatable(step27_import_cov_eg(), rownames = FALSE, filter = "top", extensions = 'Buttons',
                    options = list(pageLength = 10, 
                                   lengthMenu = c(10, 50, 100, 500, 1000),
                                   scrollX = TRUE, 
                                   dom = 'lBfrtipc',
                                   buttons = list(
                                     list(extend = 'csv', filename = "example_table"), 
                                     list(extend = 'excel', filename = "example_table")))) %>% 
        formatStyle(names(step27_import_cov_eg()), textAlign = "right") 
    })
  })
  ...
  observeEvent(input$act_step27_cov_cdf_filter, {
    ...
    ## output the table
    output$out_step27_cov_cdf_filtered <- DT::renderDataTable(server = F, {
  ...
  ### 28.0 show the example meta codon file #################
  ## import the example meta codon
  step28_import_meta_codon_eg <- reactive({
    req(input$act_step28_import_meta_codon_eg)
    
    isoforms_ribo_reads <- fread(file = "InputData/4.ribo-seq/5.riboparser/16.meta_codon/RIBO_AAA_97591_8146_meta_density.txt",
                                 index = NULL, header="auto", check.names = FALSE, sep = '\t')
    return(isoforms_ribo_reads)
  })
  
  observeEvent(input$act_step28_import_meta_codon_eg, {
    ## output the table
    output$out_step28_import_meta_codon_eg <- DT::renderDataTable(server = T, {
      DT::datatable(step28_import_meta_codon_eg(), rownames = FALSE, filter = "top", extensions = 'Buttons',
                    options = list(pageLength = 10, 
                                   lengthMenu = c(10, 50, 100, 500, 1000),
                                   scrollX = TRUE, 
                                   dom = 'lBfrtipc',
                                   buttons = list(
                                     list(extend = 'csv', filename = "example_table"), 
                                     list(extend = 'excel', filename = "example_table")))) %>% 
        formatStyle(names(step28_import_meta_codon_eg()), textAlign = "right") 
    })
  })
  
  ## import the example meta codon
  step28_import_meta_seq_eg <- reactive({
    req(input$act_step28_import_meta_seq_eg)
    
    isoforms_ribo_reads <- fread(file = "InputData/4.ribo-seq/5.riboparser/16.meta_codon/RIBO_AAA_97591_8146_meta_sequence.txt",
                                 index = NULL, header="auto", check.names = FALSE, sep = '\t')
    return(isoforms_ribo_reads)
  })
  
  observeEvent(input$act_step28_import_meta_seq_eg, {
    ## output the table
    output$out_step28_import_meta_seq_eg <- DT::renderDataTable(server = T, {
      DT::datatable(step28_import_meta_seq_eg(), rownames = FALSE, filter = "top", extensions = 'Buttons',
                    options = list(pageLength = 10, 
                                   lengthMenu = c(10, 50, 100, 500, 1000),
                                   scrollX = TRUE, 
                                   dom = 'lBfrtipc',
                                   buttons = list(
                                     list(extend = 'csv', filename = "example_table"), 
                                     list(extend = 'excel', filename = "example_table")))) %>% 
        formatStyle(names(step28_import_meta_seq_eg()), textAlign = "right") 
    })
  })
  ...
  ### 29.0 show the example SeRP enrichment file #################
  ## import the example SeRP enrichment
  step29_import_serp_enrich_meta_eg <- reactive({
    req(input$act_step29_import_serp_enrich_meta_eg)
    
    isoforms_ribo_reads <- fread(file = "InputData/4.ribo-seq/5.riboparser/20.serp_enrich/wt_ssb2_flag_1_tis_tts_metaplot.txt",
                                 index = NULL, header="auto", check.names = FALSE, sep = '\t')
    return(isoforms_ribo_reads)
  })
  
  observeEvent(input$act_step29_import_serp_enrich_meta_eg, {
    ## output the table
    output$out_step29_import_serp_enrich_meta_eg <- DT::renderDataTable(server = T, {
      DT::datatable(step29_import_serp_enrich_meta_eg(), rownames = FALSE, filter = "top", extensions = 'Buttons',
                    options = list(pageLength = 10, 
                                   lengthMenu = c(10, 50, 100, 500, 1000),
                                   scrollX = TRUE, 
                                   dom = 'lBfrtipc',
                                   buttons = list(
                                     list(extend = 'csv', filename = "example_table"), 
                                     list(extend = 'excel', filename = "example_table")))) %>% 
        formatStyle(names(step29_import_serp_enrich_meta_eg()), textAlign = "right") 
    })
  })
  ...
  ### 30.0 show the example SeRP peaks file #################
  ## import the example SeRP peaks
  step30_import_serp_enrich_peaks_eg <- reactive({
    req(input$act_step30_import_serp_enrich_peaks_eg)
    
    isoforms_ribo_reads <- fread(file = "InputData/4.ribo-seq/5.riboparser/21.serp_peaks/wt_ssb1_flag_peaks_ratio.txt",
                                 index = NULL, header="auto", check.names = FALSE, sep = '\t')
    return(isoforms_ribo_reads)
  })
  
  observeEvent(input$act_step30_import_serp_enrich_peaks_eg, {
    ## output the table
    output$out_step30_import_serp_enrich_peaks_eg <- DT::renderDataTable(server = T, {
      DT::datatable(step30_import_serp_enrich_peaks_eg(), rownames = FALSE, filter = "top", extensions = 'Buttons',
                    options = list(pageLength = 10, 
                                   lengthMenu = c(10, 50, 100, 500, 1000),
                                   scrollX = TRUE, 
                                   dom = 'lBfrtipc',
                                   buttons = list(
                                     list(extend = 'csv', filename = "example_table"), 
                                     list(extend = 'excel', filename = "example_table")))) %>% 
        formatStyle(names(step30_import_serp_enrich_peaks_eg()), textAlign = "right") 
    })
  })
  ...
  ### 31.0 show the example SeRP motif file #################
  ## import the example SeRP motif
  step31_import_serp_sequence_eg <- reactive({
    req(input$act_step31_import_serp_sequence_eg)
    
    isoforms_ribo_reads <- fread(file = "InputData/4.ribo-seq/5.riboparser/21.serp_peaks/wt_ssb1_flag_peaks_sig_sequence.txt",
                                 index = NULL, header="auto", check.names = FALSE, sep = '\t')
    return(isoforms_ribo_reads)
  })
  
  observeEvent(input$act_step31_import_serp_sequence_eg, {
    ## output the table
    output$out_step31_import_serp_sequence_eg <- DT::renderDataTable(server = T, {
      DT::datatable(step31_import_serp_sequence_eg(), rownames = FALSE, filter = "top", extensions = 'Buttons',
                    options = list(pageLength = 10, 
                                   lengthMenu = c(10, 50, 100, 500, 1000),
                                   scrollX = TRUE, 
                                   dom = 'lBfrtipc',
                                   buttons = list(
                                     list(extend = 'csv', filename = "example_table"), 
                                     list(extend = 'excel', filename = "example_table")))) %>% 
        formatStyle(names(step31_import_serp_sequence_eg()), textAlign = "right") 
    })
  })
