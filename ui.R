...
dashboardPage(
  ...
  dashboardSidebar(
    sidebarMenu(
      ...
      menuItem(text = "step6_Offset", tabName = "step6_Offset", icon = icon("chart-bar"),
               menuSubItem(text = "Frame", tabName = "step6_frame"),
               menuSubItem(text = "TIS", tabName = "step6_tis"),
               menuSubItem(text = "End", tabName = "step6_end")
      ),
      ...
      menuItem(text = "step22_Pausing", tabName = "step22_Pausing", icon = icon("chart-bar"),
               ...
               menuSubItem(text = "Diff pausing", tabName = "step22_diff_pausing")
      ),
  ...
  dashboardBody(
    ...
    tabItems(
              ...
              fluidRow(
                ...
                column(5,
                       ...
                       box(title = "Import gene annotation.", collapsed = FALSE, collapsible = TRUE,
                           width = NULL, status = "primary", solidHeader = TRUE,
                           fluidRow(
                             column(6, checkboxInput("in_step1_anno_longest", label = "longest", value = TRUE)),
                             column(6, checkboxInput("in_step1_sqrty", label = "sqrt_y", value = FALSE))
                           ),
                           ...
                           selectizeInput("in_step1_anno_type", label = "type", choices = c("cds_length", "utr5_length", "utr3_length"), selected = "cds_length"),
      ...
      ### step6 Ribo-seq frame offset ###############################
      tabItem(tabName = "step6_frame",
              h2("draw the offset of frame-model"),
              fluidRow(
                tags$style(HTML(".checkbox label {display: flex; align-items: center; margin-top: 25px;}")),
                
                ## set the input panel
                column(5,
                       box(title = "Import the frame offset.", collapsed = FALSE, collapsible = TRUE, 
                           width = NULL, status = "primary", solidHeader = TRUE,
                           ## click to import the frame-model
                ...
                column(7,
                       tabsetPanel(
                         ...
                         tabPanel(title = "Offset",
                                  h4("Show the frame offset table"),
                                  DT::dataTableOutput("out_step6_frame_offset")),
                         
                         ## set the length frame offset plot
                         tabPanel(title = "Bar",
                                  h4("Show the Ribo-seq frame offset bar plot"),
                                  plotOutput("out_step6_frame_bar")),
                         
                         tabPanel(title = "Heat",
                                  h4("Show the Ribo-seq frame offset heat plot"),
      ...
      ### step6 Ribo-seq tis offset ###############################
      tabItem(tabName = "step6_tis",
              h2("draw the offset of tis-model"),
              fluidRow(
                tags$style(HTML(".checkbox label {display: flex; align-items: center; margin-top: 25px;}")),
                
                ## set the input panel
                column(5,
                       box(title = "Import the tis offset.", collapsed = FALSE, collapsible = TRUE, 
                           width = NULL, status = "primary", solidHeader = TRUE,
                           ## click to import the tis-model
                ...
                column(7,
                       tabsetPanel(
                         ## set the output panel
                         tabPanel(title = "Offset",
                                  h4("Show the TIS offset table"),
                                  DT::dataTableOutput("out_step6_tis_offset")),
                         
                         ## set the tis offset plot
                         tabPanel(title = "Bar",
                                  h4("Show the Ribo-seq TIS offset bar plot"),
                                  plotOutput("out_step6_tis_bar")),
                         
                         tabPanel(title = "Heat",
                                  h4("Show the Ribo-seq TIS offset heat plot"),
      ...
      tabItem(tabName = "step6_end",
              h2("draw the end of offset of TIS-model"),
              fluidRow(
                tags$style(HTML(".checkbox label {display: flex; align-items: center; margin-top: 25px;}")),
              ...
              fluidRow(
                ...
                column(5,
                       ...
                       box(title = "Draw oddratio", status = "primary", collapsible = TRUE, collapsed = FALSE, 
                           ...
                           fluidRow(
                             column(6, selectizeInput("in_step26_control", label = "Control", choices = NULL, selected = NULL, multiple = TRUE)),
                             column(6, selectizeInput("in_step26_treat", label = "Treated", choices = NULL, selected = NULL, multiple = TRUE))
                           ),
                           
                           fluidRow(
                             column(4, selectizeInput("in_step26_class", label = "Odd Ratio class", choices = c("number", "proportion"), 
                           ...
                           fluidRow(
                             column(4, sliderInput("in_step26_font_size", label = "Font size", value = 15, min = 5, max = 25, step = 0.5)),
                             column(4, numericInput("in_step26_legend_row", label = "Legend rows", value = 3, min = 1))
                           ),
                           
                           fluidRow(
                             column(4, numericInput("in_step26_grid_width", label = "Grid width", value = 0.2, min = 0, step = 0.05)),
              ...
              fluidRow(
                ...
                column(5,
                       ...
                       box(title = "Draw meta codon seqlogo", status = "primary", collapsible = TRUE, collapsed = FALSE, 
                           ...
                           fluidRow(
                             column(4, selectizeInput("in_step28_meta_seq_method", label = "Method", 
                                                      choices = c('bits', 'probability', 'custom'), selected = "probability")),
                             column(4, selectizeInput("in_step28_meta_seq_font_family", label = "Font family", 
                                                      choices = seqlogo_font_family, selected = "helvetica_regular")),
