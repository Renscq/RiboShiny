  ...
  dashboardHeader(title = "RiboShiny (v0.1.0)",
                  ...
                  dropdownMenu(type = "notifications",
                               ...
                               messageItem(
                                 ...
                                 href = "https://github.com/Renscq/RiboShiny",
                                 icon("link")
                               )
                  )
  ),
              ...
              fluidRow(
                ...
                column(5,
                       box(title = "Set the design", collapsible = TRUE, collapsed = FALSE,
                           ...
                           fluidRow(
                             column(6, actionButton("act_step1_import_design", label = "import design", icon = icon("file"))),
                             column(6, actionButton("act_step1_import_design_eg", label = "show example", icon = icon("file"))),
                             
                             tags$style(HTML("#act_step1_import_design {background-color: #75aadb; color: black; margin-top: 0px;}")),
                             tags$style(HTML("#act_step1_import_design_eg {background-color: #75aadb; color: black; margin-top: 0px;}"))
                           ),
                ...
                column(7,
                       tabsetPanel(
                         ...
                         tabPanel(title = "Example",
                                  ...
                                  DT::dataTableOutput("out_step1_import_design_eg"))
              ...
              fluidRow(
                ...
                column(5,
                       ...
                       box(title = "Import gene annotation.", collapsed = FALSE,
                           ...
                           # set the input panel
                           fluidRow(
                             column(8, fileInput(inputId = "in_step1_anno", label = "annotation file", accept = c(".xlsx", ".XLSX"))),
                             column(4, numericInput("in_step1_anno_sheet", label = "sheet number", value = 1, min = 1))
                           ),
                           
                           ## click to import the annotation
                           fluidRow(
                             column(6, actionButton("act_step1_import_anno", label = "import annotation", icon = icon("file"))),
                             column(6, actionButton("act_step1_import_anno_eg", label = "show example", icon = icon("file"))),
                             
                             tags$style(HTML("#act_step1_import_anno {background-color: #75aadb; color: black;}")),
                             tags$style(HTML("#act_step1_import_anno_eg {background-color: #75aadb; color: black;}"))
                          ),
                ...
                column(7,
                       tabsetPanel(
                         ...
                         tabPanel(title = "Example",
                                  h4("Show the example of annotation file."),
                                  DT::dataTableOutput("out_step1_import_anno_eg"))
                       )
                )
              )
      ),
              ...
              fluidRow(
                ...
                column(5,
                       box(title = "Import the alignment.", collapsed = FALSE, collapsible = TRUE,
                           ...
                           fluidRow(
                             column(6, actionButton("act_step2_import_align", label = "import alignment", icon = icon("file"))),
                             column(6, actionButton("act_step2_import_align_eg", label = "show example", icon = icon("file"))),
                             
                             tags$style(HTML("#act_step2_import_align {background-color: #75aadb; color: black; margin-top: 0px;}")),
                             tags$style(HTML("#act_step2_import_align_eg {background-color: #75aadb; color: black; margin-top: 0px;}"))
                           ),
                ...
                column(7,
                       tabsetPanel(
                         ...
                         # show the example data
                         tabPanel(title = "Example",
                                  h4("Show the example of alignment file."),
                                  DT::dataTableOutput("out_step2_import_align_eg"))
                       )
                )
              )
      ),
              ...
              fluidRow(
                ...
                column(5,
                       box(title = "Import the RNA-seq length.", collapsed = FALSE, collapsible = TRUE, 
                           ...
                           fluidRow(
                             column(6, actionButton("act_step3_import_rna_length", label = "import distribution", icon = icon("file"))),
                             column(6, actionButton("act_step3_import_rna_length_eg", label = "show example", icon = icon("file"))),
                             
                             tags$style(HTML("#act_step3_import_rna_length {background-color: #75aadb; color: black; margin-top: 0px;}")),
                             tags$style(HTML("#act_step3_import_rna_length_eg {background-color: #75aadb; color: black; margin-top: 0px;}"))
                           ),
                ...
                column(7,
                       tabsetPanel(
                         ...
                         # show the example data
                         tabPanel(title = "Example",
                                  h4("Show the example of distribution file."),
                                  DT::dataTableOutput("out_step3_import_rna_length_eg"))
                       )
                )
              )
      ),
              ...
              fluidRow(
                ...
                column(5,
                       box(title = "Import the Ribo-seq length.", collapsed = FALSE, collapsible = TRUE, 
                           ...
                           fluidRow(
                             column(6, actionButton("act_step3_import_ribo_length", label = "import distribution", icon = icon("file"))),
                             column(6, actionButton("act_step3_import_ribo_length_eg", label = "show example", icon = icon("file"))),
                             
                             tags$style(HTML("#act_step3_import_ribo_length {background-color: #75aadb; color: black; margin-top: 0px;}")),
                             tags$style(HTML("#act_step3_import_ribo_length_eg {background-color: #75aadb; color: black; margin-top: 0px;}"))
                           ),
                ...
                column(7,
                       tabsetPanel(
                         ...
                         tabPanel(title = "Example",
                                  h4("Show the example of distribution file."),
                                  DT::dataTableOutput("out_step3_import_ribo_length_eg"))
                       )
                )
              )
      ),
              ...
              fluidRow(
                ...
                column(5,
                       box(title = "Import the RNA-seq saturation.", collapsed = FALSE, collapsible = TRUE,
                           ...
                           fluidRow(
                             column(6, actionButton("act_step4_import_rna_saturation", label = "import saturation", icon = icon("file"))),
                             column(6, actionButton("act_step4_import_rna_saturation_eg", label = "show example", icon = icon("file"))),
                             
                             tags$style(HTML("#act_step4_import_rna_saturation {background-color: #75aadb; color: black; margin-top: 0px;}")),
                             tags$style(HTML("#act_step4_import_rna_saturation_eg {background-color: #75aadb; color: black; margin-top: 0px;}"))
                           ),
                ...
                column(7,
                       tabsetPanel(
                         ...
                         # show the example data
                         tabPanel(title = "Example",
                                  h4("Show the example of saturation file."),
                                  DT::dataTableOutput("out_step4_import_rna_saturation_eg"))
                       )
                )
              )
      ),
              ...
              fluidRow(
                ...
                column(5,
                       box(title = "Import the RNA-seq saturation.", collapsed = FALSE, collapsible = TRUE,
                           ...
                           fluidRow(
                             column(6, actionButton("act_step4_import_ribo_saturation", label = "import saturation", icon = icon("file"))),
                             column(6, actionButton("act_step4_import_ribo_saturation_eg", label = "show example", icon = icon("file"))),
                             
                             tags$style(HTML("#act_step4_import_ribo_saturation {background-color: #75aadb; color: black; margin-top: 0px;}")),
                             tags$style(HTML("#act_step4_import_ribo_saturation_eg {background-color: #75aadb; color: black; margin-top: 0px;}"))
                           ),
                ...
                column(7,
                       tabsetPanel(
                         ...
                         tabPanel(title = "Example",
                                  h4("Show the example of saturation file."),
                                  DT::dataTableOutput("out_step4_import_ribo_saturation_eg"))
                       )
                )
              )
      ),
              ...
              fluidRow(
                ...
                column(5,
                       box(title = "Import the digestion.", collapsed = FALSE, collapsible = TRUE,
                           ...
                           fluidRow(
                             column(6, actionButton("act_step5_import_ribo_digestion", label = "import saturation", icon = icon("file"))),
                             column(6, actionButton("act_step5_import_ribo_digestion_eg", label = "show example", icon = icon("file"))),
                             
                             tags$style(HTML("#act_step5_import_ribo_digestion {background-color: #75aadb; color: black; margin-top: 0px;}")),
                             tags$style(HTML("#act_step5_import_ribo_digestion_eg {background-color: #75aadb; color: black; margin-top: 0px;}"))
                           ),
                ...
                column(7,
                       tabsetPanel(
                         ...
                         # show the example data
                         tabPanel(title = "Example",
                                  h4("Show the example of digestion file."),
                                  DT::dataTableOutput("out_step5_import_ribo_digestion_eg"))
                       )
                )
              )
      ),
              ...
              fluidRow(
                ...
                column(5,
                       box(title = "Import the RSBM offset.", collapsed = FALSE, collapsible = TRUE, 
                           ...
                           fluidRow(
                             column(6, actionButton("act_step6_import_frame_offset", label = "import offset", icon = icon("file"))),
                             column(6, actionButton("act_step6_import_frame_offset_eg", label = "show example", icon = icon("file"))),
                             
                             tags$style(HTML("#act_step6_import_frame_offset {background-color: #75aadb; color: black; margin-top: 0px;}")),
                             tags$style(HTML("#act_step6_import_frame_offset_eg {background-color: #75aadb; color: black; margin-top: 0px;}"))
                           ),
                ...
                column(7,
                       tabsetPanel(
                         ...
                         # show the example data
                         tabPanel(title = "Example",
                                  h4("Show the example of offset file."),
                                  DT::dataTableOutput("out_step6_import_frame_offset_eg"))
                       )
                )
              )
      ),
              ...
              fluidRow(
                ...
                column(5,
                       box(title = "Import the SSCBM offset.", collapsed = FALSE, collapsible = TRUE, 
                           ...
                           fluidRow(
                             column(6, actionButton("act_step6_import_tis_offset", label = "import offset", icon = icon("file"))),
                             column(6, actionButton("act_step6_import_tis_offset_eg", label = "show example", icon = icon("file"))),
                             
                             tags$style(HTML("#act_step6_import_tis_offset {background-color: #75aadb; color: black; margin-top: 0px;}")),
                             tags$style(HTML("#act_step6_import_tis_offset_eg {background-color: #75aadb; color: black; margin-top: 0px;}"))
                           ),
                ...
                column(7,
                       tabsetPanel(
                         ...
                         tabPanel(title = "Example",
                                  h4("Show the example of offset file."),
                                  DT::dataTableOutput("out_step6_import_tis_offset_eg"))
                       )
                )
              )
      ),
              ...
              fluidRow(
                ...
                column(5,
                       box(title = "Import the offset end.", collapsed = FALSE,
                           ...
                           fluidRow(
                             column(6, actionButton("act_step6_import_end_offset", label = "import offset", icon = icon("file"))),
                             column(6, actionButton("act_step6_import_end_offset_eg", label = "show example", icon = icon("file"))),
                             
                             tags$style(HTML("#act_step6_import_end_offset {background-color: #75aadb; color: black; margin-top: 0px;}")),
                             tags$style(HTML("#act_step6_import_end_offset_eg {background-color: #75aadb; color: black; margin-top: 0px;}"))
                           ),
                ...
                column(7,
                       tabsetPanel(
                         ...
                         tabPanel(title = "Example",
                                  h4("Show the example of offset file."),
                                  DT::dataTableOutput("out_step6_import_end_offset_eg"))
                       )
                )
              )
      ),
              ...
              fluidRow(
                ...
                column(5,
                       box(title = "Import the periodicity.", collapsed = FALSE, collapsible = TRUE,
                           ...
                           fluidRow(
                             column(6, actionButton("act_step7_import_rna_period", label = "import period", icon = icon("file"))),
                             column(6, actionButton("act_step7_import_rna_period_eg", label = "show example", icon = icon("file"))),
                             
                             tags$style(HTML("#act_step7_import_rna_period {background-color: #75aadb; color: black; margin-top: 0px;}")),
                             tags$style(HTML("#act_step7_import_rna_period_eg {background-color: #75aadb; color: black; margin-top: 0px;}"))
                           ),
                ...
                column(7,
                       tabsetPanel(
                         ...
                         # show the example data
                         tabPanel(title = "Example",
                                  h4("Show the example of periodicity file."),
                                  DT::dataTableOutput("out_step7_import_rna_period_eg"))
                       )
                )
              )
      ),
              ...
              fluidRow(
                ...
                column(5,
                       box(title = "Import the periodicity.", collapsed = FALSE, collapsible = TRUE,
                           ...
                           fluidRow(
                             column(6, actionButton("act_step7_import_ribo_period", label = "import period", icon = icon("file"))),
                             column(6, actionButton("act_step7_import_ribo_period_eg", label = "show example", icon = icon("file"))),
                             
                             tags$style(HTML("#act_step7_import_ribo_period {background-color: #75aadb; color: black; margin-top: 0px;}")),
                             tags$style(HTML("#act_step7_import_ribo_period_eg {background-color: #75aadb; color: black; margin-top: 0px;}"))
                           ),
                ...
                column(7,
                       tabsetPanel(
                         ...
                         tabPanel(title = "Example",
                                  h4("Show the example of periodicity file."),
                                  DT::dataTableOutput("out_step7_import_ribo_period_eg"))
                       )
                )
              )
      ),
              ...
              fluidRow(
                ...
                column(5,
                       box(title = "Import the RNA-seq meta gene.", collapsed = FALSE, collapsible = TRUE,
                           ...
                           fluidRow(
                             column(6, actionButton("act_step8_import_rna_meta", label = "import metagene", icon = icon("file"))),
                             column(6, actionButton("act_step8_import_rna_meta_eg", label = "show example", icon = icon("file"))),
                             
                             tags$style(HTML("#act_step8_import_rna_meta {background-color: #75aadb; color: black; margin-top: 0px;}")),
                             tags$style(HTML("#act_step8_import_rna_meta_eg {background-color: #75aadb; color: black; margin-top: 0px;}"))
                           ),
                ...
                column(7,
                       tabsetPanel(
                         ...
                         # show the example data
                         tabPanel(title = "Example",
                                  h4("Show the example of metagene file."),
                                  DT::dataTableOutput("out_step8_import_rna_meta_eg"))
                       )
                )
              )
      ),
              ...
              fluidRow(
                ...
                column(5,
                       box(title = "Import the Ribo-seq meta gene.", collapsed = FALSE, collapsible = TRUE,
                           ...
                           fluidRow(
                             column(6, actionButton("act_step8_import_ribo_meta", label = "import metagene", icon = icon("file"))),
                             column(6, actionButton("act_step8_import_ribo_meta_eg", label = "show example", icon = icon("file"))),
                             
                             tags$style(HTML("#act_step8_import_ribo_meta {background-color: #75aadb; color: black; margin-top: 0px;}")),
                             tags$style(HTML("#act_step8_import_ribo_meta_eg {background-color: #75aadb; color: black; margin-top: 0px;}"))
                           ),
                ...
                column(7,
                       tabsetPanel(
                         ...
                         tabPanel(title = "Example",
                                  h4("Show the example of metagene file."),
                                  DT::dataTableOutput("out_step8_import_ribo_meta_eg"))
                       )
                )
              )
      ),
              ...
              fluidRow(
                ...
                column(5,
                       box(title = "Import the RNA-seq coverage.", collapsed = FALSE, collapsible = TRUE,
                           ...
                           fluidRow(
                             column(6, actionButton("act_step9_import_rna_coverage", label = "import coverage", icon = icon("file"))),
                             column(6, actionButton("act_step9_import_rna_coverage_eg", label = "show example", icon = icon("file"))),
                             
                             tags$style(HTML("#act_step9_import_rna_coverage {background-color: #75aadb; color: black; margin-top: 0px;}")),
                             tags$style(HTML("#act_step9_import_rna_coverage_eg {background-color: #75aadb; color: black; margin-top: 0px;}"))
                           ),
                       ...
                       box(title = "Draw the RNA-seq coverage.", collapsed = FALSE, collapsible = TRUE,
                           width = NULL, status = "primary", solidHeader = TRUE,
                           fluidRow(
                             column(6, textInput("in_step9_rna_x", label = "X-axis", value = "Sample", placeholder = "need design file")), 
                             column(6, selectizeInput("in_step9_rna_value", label = "Value", selected = "Density", 
                                                      choices = c("Density", "Percentage")))
                           ), 
                           ...
                           fluidRow(
                             column(6, textInput("out_step9_rna_xlabel", label = "X label", value = "Bins", placeholder = "Position on gene")),
                             column(6, textInput("out_step9_rna_ylabel", label = "Y label", value = "Density", placeholder = "Mean RNA Density"))
                           ),
                ...
                column(7,
                       tabsetPanel(
                         ...
                         # show the example data
                         tabPanel(title = "Example",
                                  h4("Show the example of coverage file."),
                                  DT::dataTableOutput("out_step9_import_rna_coverage_eg"))
                       )
                )
              )
      ),
              ...
              fluidRow(
                ...
                column(5,
                       box(title = "Import the RNA-seq coverage.", collapsed = FALSE,
                           ...
                           fluidRow(
                             column(6, actionButton("act_step9_import_ribo_coverage", label = "import coverage", icon = icon("file"))),
                             column(6, actionButton("act_step9_import_ribo_coverage_eg", label = "show example", icon = icon("file"))),
                             
                             tags$style(HTML("#act_step9_import_ribo_coverage {background-color: #75aadb; color: black; margin-top: 0px;}")),
                             tags$style(HTML("#act_step9_import_ribo_coverage_eg {background-color: #75aadb; color: black; margin-top: 0px;}"))
                           ),
                       ...
                       box(title = "Import the RNA-seq coverage.", collapsed = FALSE, collapsible = TRUE, 
                           width = NULL, status = "primary", solidHeader = TRUE,
                           fluidRow(
                             column(6, textInput("in_step9_ribo_x", label = "X-axis", value = "Sample", placeholder = "need design file")), 
                             column(6, selectizeInput("in_step9_ribo_value", label = "Value", selected = "Density", 
                                                      choices = c("Density", "Percentage")))
                           ), 
                           ...
                           fluidRow(
                             column(6, textInput("out_step9_ribo_xlabel", label = "X label", value = "Bins", placeholder = "Position on gene")),
                             column(6, textInput("out_step9_ribo_ylabel", label = "Y label", value = "Density", placeholder = "Mean RPFs Density"))
                           ),
                ...
                column(7,
                       tabsetPanel(
                         ...
                         tabPanel(title = "Example",
                                  h4("Show the example of coverage file."),
                                  DT::dataTableOutput("out_step9_import_ribo_coverage_eg"))
                       )
                )
              )
      ),
              ...
              fluidRow(
                ...
                column(5,
                       box(title = "Import the RNA-seq data.", status = "primary", solidHeader = TRUE, 
                           ...
                           fluidRow(
                             column(6, actionButton("act_step10_import_rna_count", label = "import RNA", icon = icon("file"))),
                             column(6, actionButton("act_step10_import_rna_count_eg", label = "show example", icon = icon("file"))),
                             
                             tags$style(HTML("#act_step10_import_rna_count {background-color: #75aadb; color: black; margin-top: 0px;}")),
                             tags$style(HTML("#act_step10_import_rna_count_eg {background-color: #75aadb; color: black; margin-top: 0px;}"))
                           )
                       ),
                ...
                column(7,
                       tabsetPanel(
                         ...
                         # show the example data
                         tabPanel(title = "Example",
                                  h4("Show the example of reads count file."),
                                  DT::dataTableOutput("out_step10_import_rna_count_eg"))
              ...
              fluidRow(
                ...
                column(5,
                       box(title = "Import the Ribo-seq data.", status = "primary", 
                           ...
                           fluidRow(
                             column(6, actionButton("act_step10_import_ribo_count", label = "import RIBO", icon = icon("file"))),
                             column(6, actionButton("act_step10_import_ribo_count_eg", label = "show example", icon = icon("file"))),
                             
                             tags$style(HTML("#act_step10_import_ribo_count {background-color: #75aadb; color: black; margin-top: 0px;}")),
                             tags$style(HTML("#act_step10_import_ribo_count_eg {background-color: #75aadb; color: black; margin-top: 0px;}"))
                           )
                       ),
                ...
                column(7,
                       tabsetPanel(
                         ...
                         tabPanel(title = "Example",
                                  h4("Show the example of reads count file."),
                                  DT::dataTableOutput("out_step10_import_ribo_count_eg"))
              ...
              fluidRow(
                ...
                column(5,
                       box(title = "Import the RNA-seq and RIbo-seq data", collapsible = TRUE, collapsed = FALSE,
                           ...
                           fluidRow(
                             column(6, actionButton("act_step10_import_te_calc", label = "calculate TE", icon = icon("calculator"))),
                             column(6, downloadButton("save_step10_te_norm", label = "Save data", class = "download-btn", icon = icon("download"))),

                             tags$style(HTML("#act_step10_import_te_calc {background-color: #75aadb; color: black; margin-top: 0px;}")),
                ...
                column(7,
                       tabsetPanel(
                         ...
                         # show the example data
                         tabPanel(title = "Example",
                                  h4("Show the example of translation efficiency file."),
                                  DT::dataTableOutput("out_step10_import_te_calc_eg"))
              ...
              fluidRow(
                ...
                column(5,
                       box(title = "Import the RNA-seq data.", status = "primary", solidHeader = TRUE, collapsed = FALSE,
                           ...
                           fluidRow(
                             column(6, actionButton("act_step11_import_rna_norm", label = "import RNA", icon = icon("file"))),
                             column(6, actionButton("act_step11_import_rna_norm_eg", label = "show example", icon = icon("file"))),
                             
                             tags$style(HTML("#act_step11_import_rna_norm {background-color: #75aadb; color: black; margin-top: 0px;}")),
                             tags$style(HTML("#act_step11_import_rna_norm_eg {background-color: #75aadb; color: black; margin-top: 0px;}"))
                           ),
                           
                           downloadButton("save_step11_rna_corr", label = "save corr", class = "download-btn", icon = icon("download")),
                ...
                column(7,
                       tabsetPanel(
                         ...
                         # show the example data
                         tabPanel(title = "Example",
                                  h4("Show the example of gene abundance file."),
                                  DT::dataTableOutput("out_step11_import_rna_norm_eg"))
              ...
              fluidRow(
                ...
                column(5,
                       box(title = "Import the Ribo-seq data", status = "primary", solidHeader = TRUE, collapsed = FALSE,
                           ...
                           fluidRow(
                             column(6, actionButton("act_step11_import_ribo_norm", label = "import RIBO", icon = icon("file"))),
                             column(6, actionButton("act_step11_import_ribo_norm_eg", label = "show example", icon = icon("file"))),
                             
                             tags$style(HTML("#act_step11_import_ribo_norm {background-color: #75aadb; color: black; margin-top: 0px;}")),
                             tags$style(HTML("#act_step11_import_ribo_norm_eg {background-color: #75aadb; color: black; margin-top: 0px;}"))
                           ),
                           
                           downloadButton("save_step11_ribo_corr", label = "save corr", class = "download-btn", icon = icon("download")),
                ...
                column(7,
                       tabsetPanel(
                         ...
                         tabPanel(title = "Example",
                                  h4("Show the example of gene abundance file."),
                                  DT::dataTableOutput("out_step11_import_ribo_norm_eg"))
              ...
              fluidRow(
                ...
                column(5,
                       box(title = "Import the TE data", status = "primary", collapsed = FALSE, collapsible = TRUE,
                           ...
                           fluidRow(
                             column(6, actionButton("act_step11_import_te_norm", label = "import TE", icon = icon("file"))),
                             column(6, actionButton("act_step11_import_te_norm_eg", label = "show example", icon = icon("file"))),
                             
                             tags$style(HTML("#act_step11_import_te_norm {background-color: #75aadb; color: black; margin-top: 0px;}")),
                             tags$style(HTML("#act_step11_import_te_norm_eg {background-color: #75aadb; color: black; margin-top: 0px;}"))
                           ),
                           
                           downloadButton("save_step11_te_corr", label = "save corr", class = "download-btn", icon = icon("download")),
                           tags$style(HTML("#save_step11_te_corr {background-color: #grey; color: black; margin-top: 0px;}"))
                ...
                column(7,
                       tabsetPanel(
                         ...
                         tabPanel(title = "Example",
                                  h4("Show the example of gene abundance file."),
                                  DT::dataTableOutput("out_step11_import_te_norm_eg"))
              ...
              fluidRow(
                ...
                column(5,
                       box(title = "Import the RNA-seq data", status = "primary", collapsed = FALSE, collapsible = TRUE, 
                           ...
                           fluidRow(
                             column(6, actionButton("act_step12_import_rna_norm", label = "import RNA", icon = icon("file"))),
                             column(6, actionButton("act_step12_import_rna_norm_eg", label = "show example", icon = icon("file"))),
                             
                             tags$style(HTML("#act_step12_import_rna_norm {background-color: #75aadb; color: black; margin-top: 0px;}")),
                             tags$style(HTML("#act_step12_import_rna_norm_eg {background-color: #75aadb; color: black; margin-top: 0px;}"))
                           )
                ...
                column(7,
                       tabsetPanel(
                         ...
                         tabPanel(title = "Example",
                                  h4("Show the example of gene abundance file."),
                                  DT::dataTableOutput("out_step12_import_rna_norm_eg"))
              ...
              fluidRow(
                ...
                column(5,
                       box(title = "Import the Ribo-seq data", status = "primary", collapsed = FALSE, collapsible = TRUE, 
                           ...
                           fluidRow(
                             column(6, actionButton("act_step12_import_ribo_norm", label = "import RIBO", icon = icon("file"))),
                             column(6, actionButton("act_step12_import_ribo_norm_eg", label = "show example", icon = icon("file"))),
                             
                             tags$style(HTML("#act_step12_import_ribo_norm {background-color: #75aadb; color: black; margin-top: 0px;}")),
                             tags$style(HTML("#act_step12_import_ribo_norm_eg {background-color: #75aadb; color: black; margin-top: 0px;}"))
                           )
                ...
                column(7,
                       tabsetPanel(
                         ...
                         tabPanel(title = "Example",
                                  h4("Show the example of gene abundance file."),
                                  DT::dataTableOutput("out_step12_import_ribo_norm_eg"))
              ...
              fluidRow(
                ...
                column(5,
                       box(title = "Import the TE data", status = "primary", collapsed = FALSE, collapsible = TRUE, 
                           ...
                           fluidRow(
                             column(6, actionButton("act_step12_import_te_norm", label = "import TE", icon = icon("file"))),
                             column(6, actionButton("act_step12_import_te_norm_eg", label = "show example", icon = icon("file"))),
                             
                             tags$style(HTML("#act_step12_import_te_norm {background-color: #75aadb; color: black; margin-top: 0px;}")),
                             tags$style(HTML("#act_step12_import_te_norm_eg {background-color: #75aadb; color: black; margin-top: 0px;}"))
                           )
                       ),
                ...
                column(7,
                       tabsetPanel(
                         ...
                         tabPanel(title = "Example",
                                  h4("Show the example of gene abundance file."),
                                  DT::dataTableOutput("out_step12_import_te_norm_eg"))
              ...
              fluidRow(
                ...
                column(5,
                       box(title = "Import the expression", status = "primary",
                           ...
                           fluidRow(
                             column(6, actionButton("act_step13_import_edger", label = "import exprs", icon = icon("file"))),
                             column(6, actionButton("act_step13_import_edger_eg", label = "show example", icon = icon("file"))),
                             
                             tags$style(HTML("#act_step13_import_edger {background-color: #75aadb; color: black; margin-top: 0px;}")),
                             tags$style(HTML("#act_step13_import_edger_eg {background-color: #75aadb; color: black; margin-top: 0px;}"))
                           )
                       ),
                       ...
                       box(title = "edgeR differential analysis", status = "primary",
                           ...
                           fluidRow(
                             column(6, selectizeInput("in_step13_edger_ruvseq", label = "RUVSeq", choice = c("False", "True"), selected = 0)),
                             column(6, conditionalPanel(
                               condition = ("input.in_step13_edger_ruvseq == 'True'"),
                               numericInput("in_step13_edger_emprical_gene", label = "Number", value = 3000, min = 0)))
                           ),
                           p("The RUVseq is used to remove unwanted variation, defalut 'False'.",
                             "The Number is the number of empirical genes used to estimate the unwanted variation. 
                             The baseline gene set excludes genes ranked within the top 3000 by adjusted p-value (padj).",
                             style = "color: #7F7F7F; font-size: 13px; font-style: Italic"),
                ...
                column(7,
                       tabsetPanel(
                         ...
                         tabPanel(title = "Example",
                                  h4("Show the example of gene abundance file."),
                                  DT::dataTableOutput("out_step13_import_edger_eg"))
              ...
              fluidRow(
                ...
                column(5,
                       box(title = "Import the expression", status = "primary",
                           ...
                           fluidRow(
                             column(6, actionButton("act_step13_import_deseq2", label = "import exprs", icon = icon("file"))),
                             column(6, actionButton("act_step13_import_deseq2_eg", label = "show example", icon = icon("file"))),
                             
                             tags$style(HTML("#act_step13_import_deseq2 {background-color: #75aadb; color: black; margin-top: 0px;}")),
                             tags$style(HTML("#act_step13_import_deseq2_eg {background-color: #75aadb; color: black; margin-top: 0px;}"))
                           )
                       ),
                       ...
                       box(title = "DESeq2 differential analysis", status = "primary",
                           ...
                           fluidRow(
                             column(6, selectizeInput("in_step13_deseq2_ruvseq", label = "RUVSeq", choice = c("False", "True"), selected = 0)),
                             column(6, conditionalPanel(
                               condition = ("input.in_step13_deseq2_ruvseq == 'True'"),
                               numericInput("in_step13_deseq2_emprical_gene", label = "Number", value = 3000, min = 0)))
                           ),
                           p("The RUVseq is used to remove unwanted variation, defalut 'False'.",
                             "The Number is the number of empirical genes used to estimate the unwanted variation. 
                             The baseline gene set excludes genes ranked within the top 3000 by adjusted p-value (padj).",
                           ...
                           fluidRow(
                             column(6, numericInput("in_step13_deseq2_padj", label = "Filter padj", value = 0.05, min = 0, max = 1)),
                             column(6, numericInput("in_step13_deseq2_log2fc", label = "Filter log2FC", value = 1, min = 0, max = 10))
                ...
                column(7,
                       tabsetPanel(
                         ...
                         tabPanel(title = "Example",
                                  h4("Show the example of gene abundance file."),
                                  DT::dataTableOutput("out_step13_import_deseq2_eg"))
              ...
              fluidRow(
                ...
                column(5,
                       box(title = "Import the RNA-seq and Ribo-seq data", status = "primary", solidHeader = TRUE,
                           ...
                           fluidRow(
                             column(6, actionButton("act_step13_import_deltate", label = "import exprs", icon = icon("file"))),
                             column(6, actionButton("act_step13_import_deltate_eg", label = "show example", icon = icon("file"))),
                             
                             tags$style(HTML("#act_step13_import_deltate {background-color: #75aadb; color: black; margin-top: 0px;}")),
                             tags$style(HTML("#act_step13_import_deltate_eg {background-color: #75aadb; color: black; margin-top: 0px;}"))
                           )
                       ),
                ...
                column(7,
                       tabsetPanel(
                         ...
                         tabPanel(title = "Example",
                                  h4("Show the example of gene abundance file."),
                                  DT::dataTableOutput("out_step13_import_deltate_eg"))
              ...
              fluidRow(
                ...
                column(5,
                       ...
                       box(title = "Import the DEGs table", status = "primary", collapsible = TRUE, collapsed = FALSE,
                           ...
                           fluidRow(
                             column(6, actionButton("act_step14_import_vol_degs", label = "import DEGs", icon = icon("file"))),
                             column(6, actionButton("act_step14_import_vol_degs_eg", label = "show example", icon = icon("file"))),
                             
                             tags$style(HTML("#act_step14_import_vol_degs {background-color: #75aadb; color: black; margin-top: 0px;}")),
                             tags$style(HTML("#act_step14_import_vol_degs_eg {background-color: #75aadb; color: black; margin-top: 0px;}"))
                           )
                ...
                column(7,
                       tabsetPanel(
                         ...
                         # show the example data
                         tabPanel(title = "Example",
                                  h4("Show the example of DEGs file."),
                                  DT::dataTableOutput("out_step14_import_vol_degs_eg"))
              ...
              fluidRow(
                ...
                column(5,
                       ...
                       box(title = "Import the DEGs table", status = "primary", collapsible = TRUE, collapsed = FALSE,
                           ...
                           fluidRow(
                             column(6, actionButton("act_step14_import_quadra_degs", label = "import DEGs", icon = icon("file"))),
                             column(6, actionButton("act_step14_import_quadra_degs_eg", label = "show example", icon = icon("file"))),
                             
                             tags$style(HTML("#act_step14_import_quadra_degs {background-color: #75aadb; color: black; margin-top: 0px;}")),
                             tags$style(HTML("#act_step14_import_quadra_degs_eg {background-color: #75aadb; color: black; margin-top: 0px;}"))
                           ),

                           downloadButton("save_step14_quadra_degs", label = "save DEGs", class = "download-btn", icon = icon("download")),
                       ...
                       box(title = "Draw nine-quadrant plot", status = "primary", collapsible = TRUE, collapsed = FALSE,
                           ...
                           fluidRow(
                             column(6, actionButton("act_step14_draw_quadra_plot", label = "draw quadrant", icon = icon("file"))),
                             column(6, actionButton("act_step14_draw_quadra_plot_eg", label = "show example", icon = icon("file"))),
                             
                             tags$style(HTML("#act_step14_draw_quadra_plot {background-color: #75aadb; color: black; margin-top: 0px;}")),
                             tags$style(HTML("#act_step14_draw_quadra_plot_eg {background-color: #75aadb; color: black; margin-top: 0px;}"))
                           ),
                           
                           downloadButton("save_step14_quadra_plot", label = "Save quadrant", class = "download-btn", icon = icon("download")),
                           tags$style(HTML("#save_step14_quadra_plot {background-color: #75aadb; color: black; margin-top: 0px;}"))
                ...
                column(7,
                       tabsetPanel(
                         ...
                         tabPanel(title = "Example",
                                  h4("Show the example of DEGs file."),
                                  DT::dataTableOutput("out_step14_import_quadra_degs_eg"))
              ...
              fluidRow(
                ...
                column(5,
                       ...
                       box(title = "Import the DEGs table", status = "primary", collapsible = TRUE, collapsed = FALSE,
                           ...
                           fluidRow(
                             column(6, actionButton("act_step14_import_delta_degs", label = "import DEGs", icon = icon("file"))),
                             column(6, actionButton("act_step14_import_delta_degs_eg", label = "show example", icon = icon("file"))),
                             
                             tags$style(HTML("#act_step14_import_delta_degs {background-color: #75aadb; color: black; margin-top: 0px;}")),
                             tags$style(HTML("#act_step14_import_delta_degs_eg {background-color: #75aadb; color: black; margin-top: 0px;}"))
                           ),
                           
                           downloadButton("save_step14_delta_degs", label = "save DEGs", class = "download-btn", icon = icon("download")),
                ...
                column(7,
                       tabsetPanel(
                         ...
                         tabPanel(title = "Example",
                                  h4("Show the example of DEGs file."),
                                  DT::dataTableOutput("out_step14_import_delta_degs_eg"))
                       )
                )
              )
      ),
              ...
              fluidRow(
                ...
                column(5,
                       ...
                       box(title = "Import the data sets", status = "primary", collapsible = TRUE, collapsed = FALSE,
                           ...
                           fluidRow(
                             column(6, actionButton("act_step15_venn_calc", label = "overlap sets", icon = icon("file"))),
                             column(6, actionButton("act_step15_venn_calc_eg", label = "show example", icon = icon("file"))),
                             
                             tags$style(HTML("#act_step15_venn_calc {background-color: #75aadb; color: black; margin-top: 0px;}")),
                             tags$style(HTML("#act_step15_venn_calc_eg {background-color: #75aadb; color: black; margin-top: 0px;}"))
                           ),
                           
                           downloadButton("save_step15_venn_set", label = "save venn sets", class = "download-btn", icon = icon("download")),
                           tags$style(HTML("#save_step15_venn_set {background-color: #75aadb; color: black; margin-top: 0px;}"))
                ...
                column(7,
                       tabsetPanel(
                         ...
                         tabPanel(title = "Example",
                                  h4("Show the example of DEGs file."),
                                  DT::dataTableOutput("out_step15_venn_calc_eg"))
                       )
                )
              )
      ),
              ...
              fluidRow(
                ...
                column(5,
                       ...
                       box(title = "Import the DEGs table", status = "primary", collapsible = TRUE, collapsed = FALSE,
                           ...
                           fluidRow(
                             column(6, actionButton("act_step15_degs_venn_import", label = "import DEGs", icon = icon("file"))),
                             column(6, actionButton("act_step15_degs_venn_import_eg", label = "show example", icon = icon("file"))),
                             
                             tags$style(HTML("#act_step15_degs_venn_import {background-color: #75aadb; color: black; margin-top: 0px;}")),
                             tags$style(HTML("#act_step15_degs_venn_import_eg {background-color: #75aadb; color: black; margin-top: 0px;}"))
                           ),
                ...
                column(7,
                       tabsetPanel(
                         ...
                         tabPanel(title = "Example",
                                  h4("Show the example of DEGs file."),
                                  DT::dataTableOutput("out_step15_degs_venn_import_eg"))
                       )
                )
              )
      ),
              ...
              fluidRow(
                ...
                column(5,
                       ...
                       box(title = "Import the DEGs table", status = "primary", collapsible = TRUE, collapsed = FALSE,
                           ...
                           fluidRow(
                             column(6, actionButton("act_step15_import_merge_degs", label = "import merged DEGs", icon = icon("file"))),
                             column(6, actionButton("act_step15_import_merge_degs_eg", label = "show example", icon = icon("file"))),
                             
                             tags$style(HTML("#act_step15_import_merge_degs {background-color: #75aadb; color: black; margin-top: 0px;}")),
                             tags$style(HTML("#act_step15_import_merge_degs_eg {background-color: #75aadb; color: black; margin-top: 0px;}"))
                           )
                ...
                column(7,
                       tabsetPanel(
                         ...
                         tabPanel(title = "Example",
                                  h4("Show the example of DEGs file."),
                                  DT::dataTableOutput("out_step15_import_merge_degs_eg"))
                       )
                )
              )
      ),
              ...
              fluidRow(
                ...
                column(5,
                       ...
                       box(title = "Import the DEGs table", status = "primary", collapsible = TRUE, collapsed = FALSE, 
                           ...
                           fluidRow(
                             column(6, actionButton("act_step16_import_go_degs", label = "import DEGs", icon = icon("file"))),
                             column(6, actionButton("act_step16_import_go_degs_eg", label = "show example", icon = icon("file"))),
                             
                             tags$style(HTML("#act_step16_import_go_degs {background-color: #75aadb; color: black; margin-top: 0px;}")),
                             tags$style(HTML("#act_step16_import_go_degs_eg {background-color: #75aadb; color: black; margin-top: 0px;}"))
                           )
                       ),
                ...
                column(7,
                       tabsetPanel(
                         ...
                         tabPanel(title = "Example",
                                  h4("Show the example of DEGs file."),
                                  DT::dataTableOutput("out_step16_import_go_degs_eg"))
                       )
                )
              )
      ),
              ...
              fluidRow(
                ...
                column(5,
                       ...
                       box(title = "Import the merge DEGs table", status = "primary", collapsible = TRUE, collapsed = FALSE, 
                           ...
                           fluidRow(
                             column(6, actionButton("act_step16_import_group_go_degs", label = "import DEGs", icon = icon("file"))),
                             column(6, actionButton("act_step16_import_group_go_degs_eg", label = "show example", icon = icon("file"))),
                             
                             tags$style(HTML("#act_step16_import_group_go_degs {background-color: #75aadb; color: black; margin-top: 0px;}")),
                             tags$style(HTML("#act_step16_import_group_go_degs_eg {background-color: #75aadb; color: black; margin-top: 0px;}"))
                           )
                       ),
                ...
                column(7,
                       tabsetPanel(
                         ...
                         tabPanel(title = "Example",
                                  h4("Show the example of DEGs file."),
                                  DT::dataTableOutput("out_step16_import_group_go_degs_eg"))
                       )
                )
              )
      ),
              ...
              fluidRow(
                ...
                column(5,
                       ...
                       box(title = "Import the DEGs table", status = "primary", collapsible = TRUE, collapsed = FALSE, 
                           ...
                           fluidRow(
                             column(6, actionButton("act_step17_import_go_gsea_degs", label = "import DEGs", icon = icon("file"))),
                             column(6, actionButton("act_step17_import_go_gsea_degs_eg", label = "show example", icon = icon("file"))),
                             
                             tags$style(HTML("#act_step17_import_go_gsea_degs {background-color: #75aadb; color: black; margin-top: 0px;}")),
                             tags$style(HTML("#act_step17_import_go_gsea_degs_eg {background-color: #75aadb; color: black; margin-top: 0px;}"))
                           ),
                           
                           actionButton("act_step17_create_go_gsea_list", label = "create gene list", icon = icon("calculator")),
                ...
                column(7,
                       tabsetPanel(
                         ...
                         tabPanel(title = "Example",
                                  h4("Show the example of DEGs file."),
                                  DT::dataTableOutput("out_step17_import_go_gsea_degs_eg"))
                       )
                )
              )
      ),
              ...
              fluidRow(
                ...
                column(5,
                       ...
                       box(title = "Import the DEGs table", status = "primary", collapsible = TRUE, collapsed = FALSE, 
                           ...
                           fluidRow(
                             column(6, actionButton("act_step18_import_kegg_degs", label = "import DEGs", icon = icon("file"))),
                             column(6, actionButton("act_step18_import_kegg_degs_eg", label = "show example", icon = icon("file"))),
                             
                             tags$style(HTML("#act_step18_import_kegg_degs {background-color: #75aadb; color: black; margin-top: 0px;}")),
                             tags$style(HTML("#act_step18_import_kegg_degs_eg {background-color: #75aadb; color: black; margin-top: 0px;}"))
                           ),
                ...
                column(7,
                       tabsetPanel(
                         ...
                         tabPanel(title = "Example",
                                  h4("Show the example of DEGs file."),
                                  DT::dataTableOutput("out_step18_import_kegg_degs_eg"))
                       )
                )
              )
      ),
              ...
              fluidRow(
                ...
                column(5,
                       ...
                       box(title = "Import the DEGs table", status = "primary", collapsible = TRUE, collapsed = FALSE, 
                           ...
                           fluidRow(
                             column(6, actionButton("act_step18_import_group_kegg_degs", label = "import DEGs", icon = icon("file"))),
                             column(6, actionButton("act_step18_import_group_kegg_degs_eg", label = "show example", icon = icon("file"))),
                             
                             tags$style(HTML("#act_step18_import_group_kegg_degs {background-color: #75aadb; color: black; margin-top: 0px;}")),
                             tags$style(HTML("#act_step18_import_group_kegg_degs_eg {background-color: #75aadb; color: black; margin-top: 0px;}"))
                           ),
                ...
                column(7,
                       tabsetPanel(
                         ...
                         tabPanel(title = "Example",
                                  h4("Show the example of DEGs file."),
                                  DT::dataTableOutput("out_step18_import_group_kegg_degs_eg"))
                       )
                )
              )
      ),
              ...
              fluidRow(
                ...
                column(5,
                       ...
                       box(title = "Import the DEGs table", status = "primary", collapsible = TRUE, collapsed = FALSE, 
                           ...
                           fluidRow(
                             column(6, actionButton("act_step19_import_kegg_gsea_degs", label = "import DEGs", icon = icon("file"))),
                             column(6, actionButton("act_step19_import_kegg_gsea_degs_eg", label = "show example", icon = icon("file"))),
                             
                             tags$style(HTML("#act_step19_import_kegg_gsea_degs {background-color: #75aadb; color: black; margin-top: 0px;}")),
                             tags$style(HTML("#act_step19_import_kegg_gsea_degs_eg {background-color: #75aadb; color: black; margin-top: 0px;}"))
                           ),
                           
                           actionButton("act_step19_create_kegg_gsea_list", label = "create gene list", icon = icon("calculator")),
                ...
                column(7,
                       tabsetPanel(
                         ...
                         tabPanel(title = "Example",
                                  h4("Show the example of DEGs file."),
                                  DT::dataTableOutput("out_step19_import_kegg_gsea_degs_eg"))
                       )
                )
              )
      ),
              ...
              fluidRow(
                ...
                column(5,
                       ...
                       box(title = "Import the codon usage table", status = "primary", collapsible = TRUE, collapsed = FALSE, 
                           ...
                           fluidRow(
                             column(6, actionButton("act_step20_import_codon_table", label = "import codon table", icon = icon("file"))),
                             column(6, actionButton("act_step20_import_codon_table_eg", label = "show example", icon = icon("file"))),
                             
                             tags$style(HTML("#act_step20_import_codon_table {background-color: #75aadb; color: black; margin-top: 0px;}")),
                             tags$style(HTML("#act_step20_import_codon_table_eg {background-color: #75aadb; color: black; margin-top: 0px;}"))
                           ),
                       ...
                       box(title = "Filter the gene table", status = "primary", collapsible = TRUE, collapsed = TRUE, 
                           ...
                           fluidRow(
                             column(6, actionButton("act_step20_codon_import_gene_table", label = "import gene table", icon = icon("file"))),
                             column(6, actionButton("act_step20_codon_import_gene_table_eg", label = "show example", icon = icon("file"))),
                             
                             tags$style(HTML("#act_step20_codon_import_gene_table {background-color: #75aadb; color: black; margin-top: 0px;}")),
                             tags$style(HTML("#act_step20_codon_import_gene_table_eg {background-color: #75aadb; color: black; margin-top: 0px;}"))
                           ),
                ...
                column(7,
                       tabsetPanel(
                         ...
                         # show the example data
                         tabPanel(title = "Example",
                                  h4("Show the example of codon usage file."),
                                  DT::dataTableOutput("out_step20_import_codon_table_eg"))
                       )
                )
              )
      ),
              ...
              fluidRow(
                ...
                column(5,
                       ...
                       box(title = "Import the codon count table", status = "primary", collapsible = TRUE, collapsed = FALSE, 
                           ...
                           fluidRow(
                             column(6, actionButton("act_step20_go_import_codon_table", label = "import codon table", icon = icon("file"))),
                             column(6, actionButton("act_step20_go_import_codon_table_eg", label = "show example", icon = icon("file"))),
                             
                             tags$style(HTML("#act_step20_go_import_codon_table {background-color: #75aadb; color: black; margin-top: 0px;}")),
                             tags$style(HTML("#act_step20_go_import_codon_table_eg {background-color: #75aadb; color: black; margin-top: 0px;}"))
                           ),
                       ),
                ...
                column(7,
                       tabsetPanel(
                         ...
                         tabPanel(title = "Example",
                                  h4("Show the example of codon usage file."),
                                  DT::dataTableOutput("out_step20_go_import_codon_table_eg"))
                       )
                )
              )
      ),
              ...
              fluidRow(
                ...
                column(5,
                       ...
                       box(title = "Import the codon count table", status = "primary", collapsible = TRUE, collapsed = FALSE, 
                           ...
                           fluidRow(
                             column(6, actionButton("act_step20_kegg_import_codon_table", label = "import codon table", icon = icon("file"))),
                             column(6, actionButton("act_step20_kegg_import_codon_table_eg", label = "show example", icon = icon("file"))),
                             
                             tags$style(HTML("#act_step20_kegg_import_codon_table {background-color: #75aadb; color: black; margin-top: 0px;}")),
                             tags$style(HTML("#act_step20_kegg_import_codon_table_eg {background-color: #75aadb; color: black; margin-top: 0px;}"))
                           ),
                ...
                column(7,
                       tabsetPanel(
                         ...
                         tabPanel(title = "Example",
                                  h4("Show the example of codon usage file."),
                                  DT::dataTableOutput("out_step20_kegg_import_codon_table_eg"))
                       )
                )
              )
      ),
              ...
              fluidRow(
                ...
                column(5,
                       ...
                       box(title = "Import the reads density", status = "primary", collapsible = TRUE, collapsed = FALSE,
                           ...
                           fluidRow(
                             column(6, actionButton("act_step21_isoforms_import_rna_seq", label = "import RNA density", icon = icon("file"))),
                             column(6, actionButton("act_step21_isoforms_import_ribo_seq", label = "import RIBO density", icon = icon("file"))),
                             
                             tags$style(HTML("#act_step21_isoforms_import_rna_seq {background-color: #75aadb; color: black; margin-top: 0px;}")),
                             tags$style(HTML("#act_step21_isoforms_import_ribo_seq {background-color: #75aadb; color: black; margin-top: 0px;}"))
                           ),
                           
                           actionButton("act_step21_isoforms_import_ribo_seq_eg", label = "show example", icon = icon("file")),
                           tags$style(HTML("#act_step21_isoforms_import_ribo_seq_eg {background-color: #75aadb; color: black; margin-top: 0px;}"))
                ...
                column(7,
                       tabsetPanel(
                         ...
                         tabPanel(title = "Example",
                                  h4("Show the example of DEGs file."),
                                  DT::dataTableOutput("out_step21_isoforms_import_ribo_seq_eg"))
                       )
                )
              )
      ),
              ...
              fluidRow(
                ...
                column(5,
                       ...
                       box(title = "Import the pausing score", status = "primary", collapsible = TRUE, collapsed = FALSE, 
                           ...
                           fluidRow(
                             column(6, actionButton("act_step22_import_pausing", label = "import pausing score", icon = icon("file"))),
                             column(6, actionButton("act_step22_import_pausing_eg", label = "show example", icon = icon("file"))),
                             
                             tags$style(HTML("#act_step22_import_pausing {background-color: #75aadb; color: black; margin-top: 0px;}")),
                             tags$style(HTML("#act_step22_import_pausing_eg {background-color: #75aadb; color: black; margin-top: 0px;}"))
                           ),
                ...
                column(7,
                       tabsetPanel(
                         ...
                         # show the example data
                         tabPanel(title = "Example",
                                  h4("Show the example of pausing score file."),
                                  DT::dataTableOutput("out_step22_import_pausing_eg"))
                       )
                )
              )
      ),
              ...
              fluidRow(
                ...
                column(5,
                       ...
                       box(title = "Import the pausing score", status = "primary", collapsible = TRUE, collapsed = FALSE, 
                           ...
                           fluidRow(
                             column(6, actionButton("act_step22_diff_import_pausing", label = "import pausing score", icon = icon("file"))),
                             column(6, actionButton("act_step22_diff_import_pausing_eg", label = "show example", icon = icon("file"))),
                             
                             tags$style(HTML("#act_step22_diff_import_pausing {background-color: #75aadb; color: black; margin-top: 0px;}")),
                             tags$style(HTML("#act_step22_diff_import_pausing_eg {background-color: #75aadb; color: black; margin-top: 0px;}"))
                           ),
                ...
                column(7,
                       tabsetPanel(
                         ...
                         tabPanel(title = "Example",
                                  h4("Show the example of pausing score file."),
                                  DT::dataTableOutput("out_step22_diff_import_pausing_eg"))
                       )
                )
              )
      ),
              ...
              fluidRow(
                ...
                column(5,
                       ...
                       box(title = "Import the occupancy", status = "primary", collapsible = TRUE, collapsed = FALSE, 
                           ...
                           fluidRow(
                             column(6, actionButton("act_step23_import_occupancy", label = "import codon occupancy", icon = icon("file"))),
                             column(6, actionButton("act_step23_import_occupancy_eg", label = "show example", icon = icon("file"))),
                             
                             tags$style(HTML("#act_step23_import_occupancy {background-color: #75aadb; color: black; margin-top: 0px;}")),
                             tags$style(HTML("#act_step23_import_occupancy_eg {background-color: #75aadb; color: black; margin-top: 0px;}"))
                           ),
                ...
                column(7,
                       tabsetPanel(
                         ...
                         # show the example data
                         tabPanel(title = "Example",
                                  h4("Show the example of codon occupancy file."),
                                  DT::dataTableOutput("out_step23_import_occupancy_eg"))
                       )
                )
              )
      ),
              ...
              fluidRow(
                ...
                column(5,
                       ...
                       box(title = "Import the occupancy", status = "primary", collapsible = TRUE, collapsed = FALSE, 
                           ...
                           fluidRow(
                             column(6, actionButton("act_step23_diff_import_occupancy", label = "import codon occupancy", icon = icon("file"))),
                             column(6, actionButton("act_step23_diff_import_occupancy_eg", label = "show example", icon = icon("file"))),
                             
                             tags$style(HTML("#act_step23_diff_import_occupancy {background-color: #75aadb; color: black; margin-top: 0px;}")),
                             tags$style(HTML("#act_step23_diff_import_occupancy_eg {background-color: #75aadb; color: black; margin-top: 0px;}"))
                           ),
                ...
                column(7,
                       tabsetPanel(
                         ...
                         tabPanel(title = "Example",
                                  h4("Show the example of codon occupancy file."),
                                  DT::dataTableOutput("out_step23_diff_import_occupancy_eg"))
                       )
                )
              )
      ),
              ...
              fluidRow(
                ...
                column(5,
                       ...
                       box(title = "Import the cdt", status = "primary", collapsible = TRUE, collapsed = FALSE, 
                           ...
                           fluidRow(
                             column(6, actionButton("act_step24_import_cdt", label = "import cdt", icon = icon("file"))),
                             column(6, actionButton("act_step24_import_cdt_eg", label = "show example", icon = icon("file"))),
                             
                             tags$style(HTML("#act_step24_import_cdt {background-color: #75aadb; color: black; margin-top: 0px;}")),
                             tags$style(HTML("#act_step24_import_cdt_eg {background-color: #75aadb; color: black; margin-top: 0px;}"))
                           ),
                ...
                column(7,
                       tabsetPanel(
                         ...
                         # show the example data
                         tabPanel(title = "Example",
                                  h4("Show the example of codon decoding time file."),
                                  DT::dataTableOutput("out_step24_import_cdt_eg"))
                       )
                )
              )
      ),
              ...
              fluidRow(
                ...
                column(5,
                       ...
                       box(title = "Import the cdt", status = "primary", collapsible = TRUE, collapsed = FALSE, 
                           ...
                           fluidRow(
                             column(6, actionButton("act_step24_diff_import_cdt", label = "import cdt", icon = icon("file"))),
                             column(6, actionButton("act_step24_diff_import_cdt_eg", label = "show example", icon = icon("file"))),
                             
                             tags$style(HTML("#act_step24_diff_import_cdt {background-color: #75aadb; color: black; margin-top: 0px;}")),
                             tags$style(HTML("#act_step24_diff_import_cdt_eg {background-color: #75aadb; color: black; margin-top: 0px;}"))
                           ),
                ...
                column(7,
                       tabsetPanel(
                         ...
                         tabPanel(title = "Example",
                                  h4("Show the example of codon decoding time file."),
                                  DT::dataTableOutput("out_step24_diff_import_cdt_eg"))
                       )
                )
              )
      ),
              ...
              fluidRow(
                ...
                column(5,
                       ...
                       box(title = "Import the cst", status = "primary", collapsible = TRUE, collapsed = FALSE, 
                           ...
                           fluidRow(
                             column(6, actionButton("act_step25_import_cst", label = "import cst", icon = icon("file"))),
                             column(6, actionButton("act_step25_import_cst_eg", label = "show example", icon = icon("file"))),
                             
                             tags$style(HTML("#act_step25_import_cst {background-color: #75aadb; color: black; margin-top: 0px;}")),
                             tags$style(HTML("#act_step25_import_cst_eg {background-color: #75aadb; color: black; margin-top: 0px;}"))
                           ),
                ...
                column(7,
                       tabsetPanel(
                         ...
                         # show the example data
                         tabPanel(title = "Example",
                                  h4("Show the example of codon selection time file."),
                                  DT::dataTableOutput("out_step25_import_cst_eg"))
                       )
                )
              )
      ),
              ...
              fluidRow(
                ...
                column(5,
                       ...
                       box(title = "Import the cst", status = "primary", collapsible = TRUE, collapsed = FALSE, 
                           ...
                           fluidRow(
                             column(6, actionButton("act_step25_diff_import_cst", label = "import cst", icon = icon("file"))),
                             column(6, actionButton("act_step25_diff_import_cst_eg", label = "show example", icon = icon("file"))),
                             
                             tags$style(HTML("#act_step25_diff_import_cst {background-color: #75aadb; color: black; margin-top: 0px;}")),
                             tags$style(HTML("#act_step25_diff_import_cst_eg {background-color: #75aadb; color: black; margin-top: 0px;}"))
                           ),
                ...
                column(7,
                       tabsetPanel(
                         ...
                         tabPanel(title = "Example",
                                  h4("Show the example of codon selection time file."),
                                  DT::dataTableOutput("out_step25_diff_import_cst_eg"))
                       )
                )
              )
      ),
              ...
              fluidRow(
                ...
                column(5,
                       ...
                       box(title = "Import the oddratio", status = "primary", collapsible = TRUE, collapsed = FALSE,
                           ...
                           fluidRow(
                             column(6, actionButton("act_step26_import_odd_ratio", label = "import oddratio", icon = icon("file"))),
                             column(6, actionButton("act_step26_import_odd_ratio_eg", label = "show example", icon = icon("file"))),
                             
                             tags$style(HTML("#act_step26_import_odd_ratio {background-color: #75aadb; color: black; margin-top: 0px;}")),
                             tags$style(HTML("#act_step26_import_odd_ratio_eg {background-color: #75aadb; color: black; margin-top: 0px;}"))
                           ),
                ...
                column(7,
                       tabsetPanel(
                         ...
                         # show the example data
                         tabPanel(title = "Example",
                                  h4("Show the example of odd ratio file."),
                                  DT::dataTableOutput("out_step26_import_odd_ratio_eg"))
                       )
                )
              )
      ),
              ...
              fluidRow(
                ...
                column(5,
                       ...
                       box(title = "Import the CoV", status = "primary", collapsible = TRUE, collapsed = FALSE, 
                           ...
                           fluidRow(
                             column(6, actionButton("act_step27_import_cov", label = "import CoV", icon = icon("file"))),
                             column(6, actionButton("act_step27_import_cov_eg", label = "show example", icon = icon("file"))),
                             
                             tags$style(HTML("#act_step27_import_cov {background-color: #75aadb; color: black; margin-top: 0px;}")),
                             tags$style(HTML("#act_step27_import_cov_eg {background-color: #75aadb; color: black; margin-top: 0px;}"))
                           ),
                ...
                column(7,
                       tabsetPanel(
                         ...
                         # show the example data
                         tabPanel(title = "Example",
                                  h4("Show the example of coefficient of variation file."),
                                  DT::dataTableOutput("out_step27_import_cov_eg"))
                       )
                )
              )
      ),
              ...
              fluidRow(
                ...
                column(5,
                       ...
                       box(title = "Import the CoV eCDF", status = "primary", collapsible = TRUE, collapsed = FALSE,
                           ...
                           fluidRow(
                             column(6, actionButton("act_step27_cov_cdf_import", label = "import CoV eCDF", icon = icon("file"))),
                             column(6, actionButton("act_step27_cov_cdf_import_eg", label = "show example", icon = icon("file"))),
                             
                             tags$style(HTML("#act_step27_cov_cdf_import {background-color: #75aadb; color: black; margin-top: 0px;}")),
                             tags$style(HTML("#act_step27_cov_cdf_import_eg {background-color: #75aadb; color: black; margin-top: 0px;}"))
                           ),
                ...
                column(7,
                       tabsetPanel(
                         ...
                         tabPanel(title = "Example",
                                  h4("Show the example of coefficient of variation file."),
                                  DT::dataTableOutput("out_step27_cov_cdf_import_eg"))
                       )
                )
              )
      ),
              ...
              fluidRow(
                ...
                column(5,
                       ...
                       box(title = "Import the meta codon density", status = "primary", collapsible = TRUE, collapsed = FALSE, 
                           ...
                           fluidRow(
                             column(6, actionButton("act_step28_import_meta_codon", label = "import density", icon = icon("file"))),
                             column(6, actionButton("act_step28_import_meta_codon_eg", label = "show example", icon = icon("file"))),
                             
                             tags$style(HTML("#act_step28_import_meta_codon {background-color: #75aadb; color: black; margin-top: 0px;}")),
                             tags$style(HTML("#act_step28_import_meta_codon_eg {background-color: #75aadb; color: black; margin-top: 0px;}"))
                           ),
                ...
                column(7,
                       tabsetPanel(
                         ...
                         # show the example data
                         tabPanel(title = "Example",
                                  h4("Show the example of meta-codon file."),
                                  DT::dataTableOutput("out_step28_import_meta_codon_eg"))
                       )
                )
              )
      ),
      
      ### step28 draw the meta-codon seqlogo ##############################################################
              ...
              fluidRow(
                ...
                column(5,
                       ...
                       box(title = "Import the meta codon sequence", status = "primary", collapsible = TRUE, collapsed = FALSE, 
                           ...
                           fluidRow(
                             column(6, actionButton("act_step28_import_meta_seq", label = "import sequence", icon = icon("file"))),
                             column(6, actionButton("act_step28_import_meta_seq_eg", label = "show example", icon = icon("file"))),
                             
                             tags$style(HTML("#act_step28_import_meta_seq {background-color: #75aadb; color: black; margin-top: 0px;}")),
                             tags$style(HTML("#act_step28_import_meta_seq_eg {background-color: #75aadb; color: black; margin-top: 0px;}"))
                           ),
                ...
                column(7,
                       tabsetPanel(
                         ...
                         # show the example data
                         tabPanel(title = "Example",
                                  h4("Show the example of meta-codon sequence file."),
                                  DT::dataTableOutput("out_step28_import_meta_seq_eg"))
                       )
                )
              )
      ),
              ...
              fluidRow(
                ...
                column(5,
                       ...
                       box(title = "Import the meta gene", status = "primary", collapsible = TRUE, collapsed = FALSE, 
                           ...
                           fluidRow(
                             column(6, actionButton("act_step29_import_serp_enrich_meta", label = "import metagene", icon = icon("file"))),
                             column(6, actionButton("act_step29_import_serp_enrich_meta_eg", label = "show example", icon = icon("file"))),
                             
                             tags$style(HTML("#act_step29_import_serp_enrich_meta {background-color: #75aadb; color: black; margin-top: 0px;}")),
                             tags$style(HTML("#act_step29_import_serp_enrich_meta_eg {background-color: #75aadb; color: black; margin-top: 0px;}"))
                           ),
                ...
                column(7,
                       tabsetPanel(
                         ...
                         # show the example data
                         tabPanel(title = "Example",
                                  h4("Show the example of serp enrichment file."),
                                  DT::dataTableOutput("out_step29_import_serp_enrich_meta_eg"))
                       )
                )
              )
      ),
              ...
              fluidRow(
                ...
                column(5,
                       ...
                       box(title = "Import the meta gene", status = "primary", collapsible = TRUE, collapsed = FALSE, 
                           ...
                           fluidRow(
                             column(6, actionButton("act_step30_import_serp_enrich_peaks", label = "import enrich peaks", icon = icon("file"))),
                             column(6, actionButton("act_step30_import_serp_enrich_peaks_eg", label = "show example", icon = icon("file"))),
                             
                             tags$style(HTML("#act_step30_import_serp_enrich_peaks {background-color: #75aadb; color: black; margin-top: 0px;}")),
                             tags$style(HTML("#act_step30_import_serp_enrich_peaks_eg {background-color: #75aadb; color: black; margin-top: 0px;}"))
                           ),
                ...
                column(7,
                       tabsetPanel(
                         ...
                         # show the example data
                         tabPanel(title = "Example",
                                  h4("Show the example of serp peaks file."),
                                  DT::dataTableOutput("out_step30_import_serp_enrich_peaks_eg"))
                       )
                )
              )
      ),
              ...
              fluidRow(
                ...
                column(5,
                       ...
                       box(title = "Import the sequence data", status = "primary", collapsible = TRUE, collapsed = FALSE, 
                           ...
                           fluidRow(
                             column(6, actionButton("act_step31_import_serp_sequence", label = "import peaks sequence", icon = icon("file"))),
                             column(6, actionButton("act_step31_import_serp_sequence_eg", label = "show example", icon = icon("file"))),
                             
                             tags$style(HTML("#act_step31_import_serp_sequence {background-color: #75aadb; color: black; margin-top: 0px;}")),
                             tags$style(HTML("#act_step31_import_serp_sequence_eg {background-color: #75aadb; color: black; margin-top: 0px;}"))
                           ),
                ...
                column(7,
                       tabsetPanel(
                         ...
                         # show the example data
                         tabPanel(title = "Example",
                                  h4("Show the example of serp motif file."),
                                  DT::dataTableOutput("out_step31_import_serp_sequence_eg"))
                       )
                )
              )
      )
